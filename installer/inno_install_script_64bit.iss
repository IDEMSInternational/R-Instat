...
AppId={{2DD18D53-3DF3-43EA-90FF-195EAFB334C4}
AppName=R-Instat
#define AppVerName "0.6.4"
...
Name: "quicklaunchicon"; Description: "{cm:CreateQuickLaunchIcon}"; GroupDescription: "{cm:AdditionalIcons}"; OnlyBelowVersion: 0,6.5
...
[Icons]
Name: "{group}\R-Instat 0.6.4"; Filename: "{app}\instat.exe"
Name: "{group}\{cm:UninstallProgram,R-Instat}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\R-Instat 0.6.4"; Filename: "{app}\instat.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\R-Instat 0.6.4"; Filename: "{app}\instat.exe"; Tasks: quicklaunchicon
