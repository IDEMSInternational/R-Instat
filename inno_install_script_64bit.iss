...
DefaultDirName={autopf}\R-Instat\{#SetupSetting("AppVersion")}\
...
[Files]
Source: "instat\bin\x64\instat.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "instat\bin\x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
