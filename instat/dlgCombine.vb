...
Public Class dlgCombine
    ...
    Private Sub InitialiseDialog()
        ...
        'ucrSelector
        ucrSelectorCombineFactors.SetParameter(New RParameter("data_name"))
        ucrSelectorCombineFactors.SetParameterIsString()

        'ucrReceiver
        ucrFactorsReceiver.SetParameter(New RParameter("col_names"))
