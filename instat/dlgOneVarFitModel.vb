    ...
    Private Sub SetBinomialTest()
        ...
        If chkBinModify.Checked Then
            If UcrReceiver.strCurrDataType = "factor" OrElse UcrReceiver.strCurrDataType = "character" Then
                ...
                clsFactorOperator.AddParameter(bSetFirst:=True, clsRFunctionParameter:=UcrReceiver.GetVariables())
                clsFactorOperator.AddParameter(bSetFirst:=False, strParameterValue:=cboVariables.GetText())
            Else
                ...
                clsFunctionOperator.AddParameter(bSetFirst:=True, clsRFunctionParameter:=UcrReceiver.GetVariables())
                clsFunctionOperator.AddParameter(bSetFirst:=False, strParameterValue:=nudBinomialConditions.Value.ToString())
            End If
        Else
