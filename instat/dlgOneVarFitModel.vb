...
Public Class dlgOneVarFitModel
    Private clsROneVarFitModel, clsRLogLikFunction, clsRfitdist, clsRConvertVector, clsNaExclude, clsRConvertInteger, clsRConvertNumeric As New RFunction
