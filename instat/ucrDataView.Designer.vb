...
Partial Class ucrDataView
    ...
    Private Sub InitializeComponent()
        ...
        Me.mnuEditCell.Text = "Edit Cell(s)"
        '
        'ToolStripSeparator3
        '
