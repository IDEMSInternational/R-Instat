...
Public Class BlockReader
    ...
    'Task: would need to identify the main R command, the assignTo methods and the secondary R commands. 'Warning, blocks are for the moment blocks of RunRScript. So secondary R Commands are not in the same block as main R command. Need to work on this from different points of view: RSyntax, RunRScript, Output and Block Selection.
