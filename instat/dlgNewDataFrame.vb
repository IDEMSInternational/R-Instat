...
Public Class dlgNewDataFrame
    ...
    '        ElseIf rdoCommand.Checked OrElse rdoRandom.Checked Then
    '            strScript = GetRunnableCommand()
    '            'strScript = ucrBase.clsRsyntax.GetScript()
    '            'lstScriptCommands.AddRange(strScript.Split(New String() {Environment.NewLine}, StringSplitOptions.None))
    '        End If

    '        Dim expressionValue As SymbolicExpression = frmMain.clsRLink.RunInternalScriptGetValue(strScript, bSilent:=True)

    '        If expressionValue Is Nothing Then
