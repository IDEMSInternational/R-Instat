...
Public Class dlgInventoryPlot
    ...
    Private clsSetRcodeForControls As New RFunction
    ...
    Private Sub InitialiseDialog()
        ...
        ucrPnlSummaryAndGraph.AddRadioButton(rdoSummary)
        ucrPnlSummaryAndGraph.AddRadioButton(rdoGraph)
    ...
    Private Sub SetRCodeForControls(bReset As Boolean)
        ...
        ucrPnlSummaryAndGraph.SetRCode(clsSetRcodeForControls, bReset)
    End Sub
    ...
    Private Sub ucrPnlSummaryAndGraph_ControlValueChanged() Handles ucrPnlSummaryAndGraph.ControlValueChanged
