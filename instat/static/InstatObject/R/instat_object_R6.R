...
instat_object$set("public", "replace_value_in_data", function(data_name, col_names, row, old_value = "", start_value = NA, end_value = NA, new_value) {
  self$get_data_objects(data_name)$replace_value_in_data(col_names, old_value, start_value, end_value, new_value)
} 
)
