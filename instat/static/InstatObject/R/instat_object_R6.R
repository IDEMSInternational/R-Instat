...
instat_object$set("public", "rename_column_in_data", function(data_name, column_name, new_val, value) {
  self$get_data_objects(data_name)$rename_column_in_data(column_name, new_val, value)
...
instat_object$set("public", "rename_dataframe", function(data_name, new_value = "", value = "") {
  ...
  self$get_data_objects(data_name)$append_to_variables_metadata(property= "label" , new_val = value)
 } 
)
