...
DataBook$set("public", "add_flag_fields", function(data_name, col_names, station, date) {
  self$get_data_objects(data_name)$add_flag_fields(col_names = col_names, station = station, date = date)
}
)
