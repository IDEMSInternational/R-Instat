...
instat_object$set("public","display_daily_graph", function(data_name, station_col = NULL, year_col = NULL, doy_col = NULL, climatic_element = NULL, upper_limit = 100, bar_colour = "blue", rug_colour = "red") {
  self$get_data_objects(data_name)$display_daily_graph(date_col = date_col,station_col = station_col, year_col = year_col, doy_col = doy_col, climatic_element = element_cols, rug_colour = rug_colour, bar_colour = bar_colour, upper_limit = upper_limit)
}
)
