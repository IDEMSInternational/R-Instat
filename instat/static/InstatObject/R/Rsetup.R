...
packs <- c("abind", "agricolae", "agridat", "agriTutorial", 
        ...
        "mvtnorm", "nanonext", "ncdf4", "nlme", "nloptr", "nnet", "nortest", 
        ...
        "pbs", "performance", "permute", "pillar", "pingr", "pkgbuild", 
        "pkgconfig", "pkgdown", "pkgload", "PlackettLuce", "plogr", "plotly", 
        ...
        "proj4", "promises", "proxy", "ps", "psychotools", "psychotree", 
        "purrr", "qap", "quadprog", "quantmod", "quantreg", "questionr", 
        "QuickJSR", "qvcalc", "R.cache", "R.methodsS3", "R.oo", "R.utils", 
        "R6", "ragg", "rainfarmr", "rappdirs", "raster", "rasterVis", 
        "rbibutils", "rcmdcheck", "RColorBrewer", "rcorpora", "Rcpp", 
        "RcppArmadillo", "RcppEigen", "RcppParallel", "RcppRoll", "RCurl", 
        "Rdpack", "reactable", "reactR", "readODS", "readr", "readxl", 
        "recipes", "reformulas", "registry", "relimp", "rematch", "rematch2", 
        "remotes", "repr", "reshape", "reshape2", "rgl", "rio", "rje", 
        "rlang", "rmarkdown", "RMAWGEN", "Rmpfr", "RMySQL", "robustbase", 
        "rootSolve", "roxygen2", "rpart", "rpivotTable", "rprojroot", 
        "rrefine", "RSpectra", "RSQLite", "rstan", "rstanarm", "rstantools", 
        "rstatix", "rstudioapi", "rtf", "Rttf2pt1", "rversions", "rvest", 
        "rworldmap", "rworldxtra", "s2", "sandwich", "sass", "scales", 
        "scatterplot3d", "scs", "SearchTrees", "segmented", "selectr", 
...
versions <- c("1.4-8", "1.3-7", "1.24", "0.1.5", "1.2.1.2", "2.8.235", 
            ...
            "0.9.12-4.7", "1.12.0", "0.15.3", "1.87.0-1", "0.3.1", "4.6.0", 
            ...
            "0.3.2", "1.4-0", "1.11.1", "3.1.0", "1.5.1", "1.0.3", "1.16", 
            ...
            "0.4.0", "2.2.1", "0.10.2", "0.12.0", "0.4.17", "0.3.3", "3.5.2", 
            "0.1.2", "0.6.1", "0.5.8-1", "0.6.0", "0.9.6", "0.5.6", "3.2.0", 
            "0.3.1", "0.6.4", "0.9.0", "0.1.2", "5.1.0", "0.6.2", "1.4.1", 
            "0.1.2", "2.6.7", "4.1-8", "0.1.2", "0.17.0", "1.8.0", "0.7-5", 
            "1.1-5", "1.2-3", "1.0.2", "2.3", "0.5-1", "0.1.5", "1.0.0", 
            "0.3.6", "0.5.0", "3.9.5", "1.4.1", "2.5.4", "1.7.4", "1.0.1", 
            "1.28.5", "3.1-53", "0.11", "0.9-3", "5.2-3", "1.1.3", "2.4.3", 
            "0.5.8.1", "1.6.4", "1.6.16", "1.4.7", "1.1.2", "0.6-0.1", "0.7-0.1", 
            "1.2-14", "2.1.4", "3.3", "1.0.8", "0.3.1", "0.3.21", "1.2.0", 
            "1.1-6", "1.0-5", "0.9-15", "1.4", "0.2.7", "1.0.14", "1.0.0", 
            "2.2.1", "2.7-6", "0.1-11", "0.1.4", "2.0.0", "0.1.0", "2.2.1", 
            "2.23-26", "1.3.2", "1.50", "0.4.3", "2.14.0", "12.0-0", "1.4.2", 
            "0.22-7", "0.6-30", "1.8.1", "0.2.2", "3.2", "0.5.0", "1.0-10", 
            "1.0.4", "0.9.1", "0.7", "1.1-37", "3.1-3", "1.7-4", "3.2", "2.5.1", 
            "1.3-1", "0.9-40", "2.8.0", "1.9.4", "2.0.3", "2.3.1", "1.2.11", 
            "3.4.2.1", "2.0", "7.3-65", "1.7-3", "0.5-4", "1.5.0", "0.2.1", 
            "2.0.1", "0.18.0", "1.9-3", "3.17.0", "3.17-44", "1.5.0", "0.13", 
            "0.1.2", "1.2.8", "0.0.5", "0.4-5", "2.4", "0.8", "1.2", "2.1-6", 
            "1.4.0", "1.2.2.2", "0.1.11", "0.2-24", "0.7.0", "1.9.1", "0.9.4.0", 
            "0.20.4", "1.4-28", "0.1-10", "1.3-3", "1.5.2", "1.24", "3.1-168", 
            "2.2.1", "7.3-20", "1.0-4", "2016.8-1.1", "1.0.2", "2.18-2", 
            "2.3.2", "4.2.8", "1.6.3", "2023.12-4.1", "0.6.3.3", "1.6.0", 
            "1.9", "1.43.0", "0.25.0", "1.2-24", "1.3.0", "1.7-2", "0.5.4", 
            "1.1", "0.13.0", "0.9-7", "1.10.2", "2.0.5", "1.4.7", "2.0.3", 
            "2.1.2", "1.4.0", "0.4.3", "0.2.0", "4.10.4", "3.8-4", "2.8-5", 
            "1.8.9", "0.1-8", "1.4-1", "1.6.1", "1.0.0", "0.3.18", "1.2.0", 
            "1.6.1", "1.1.2", "1.18.5", "3.8.6", "2025.04.28", "0.1.1", "0.4.0", 
            "1.2.3", "0.15.1", "1.0-15", "1.3.2", "0.4-27", "1.9.1", "0.7-4", 
            "0.16-1", "1.0.4", "0.1-2", "1.5-8", "0.4.27", "6.1", "0.8.0", 
            "1.7.0", "1.0.4", "0.17.0", "1.8.2", "1.27.1", "2.13.0", "2.6.1", 
            ...
            "1.5-4", "1.10.3", "3.8-3", "2.1.3", "3.4.3", "1.2.3", "0.36.2.1", 
            "1.8-42", "3.2.3", "2.4.9", "1.0.1", "1.1-3", "0.3.4", "3.2.1", 
            "1.3.1", "1.2.1", "0.4.2", "0.3.0", "4041.110", "0.57", "0.7.5.3", 
            "0.3.0", "2.5.6", "1.1.6", "1.3.1", "0.10-58", "1.2-4", "0.24.4", 
            "0.5.0", "1.2.2", "0.8-7", "1.3-4", "1.0.1", "3.1.0", "1.2.5", 
            "6.0.3", "1.6-1", "1.4-13", "0.8-5", "0.6.5", "2.6-10", "1.44", 
            "0.6.5", "0.4.2", "0.6.0", "2.7.0", "1.6.5", "1.0.2", "0.3.6", 
            "0.6.1", "1.2.2", "1.0", "1.0.4", "0.4.1", "3.0.2", "0.9.4", 
            "2.6", "1.5.4", "0.52", "3.99-0.18", "1.3.8", "1.0.1", "1.8-4", 
            "0.14.1", "2.3.10", "0.2.0", "2.3.2", "1.8-14", "0.2.1", "0.11-1",
              # mmtable2 package from GitHub added manually to list
              # aida-package package from GitHub added manually to list
              # CDT package from GitHub added manually to list
              # instatClimatic package from GitHub added manually to list
