...
packs <- c("abind", "agricolae", "agridat", 
           ...
           "RMAWGEN", "Rmpfr", "RMySQL", "robustbase", 
           "rootSolve", "roxygen2", "rpart", "rpivotTable", 
           "rprojroot", "rrefine", "RSQLite", "rstan", 
           "rstanarm", "rstantools", "rstatix", "rstudioapi", 
           "rtf", "Rttf2pt1", "rversions", "rvest", 
           "rworldmap", "rworldxtra", "s2", "sandwich", 
           "sass", "scales", "scatterplot3d", "SearchTrees", 
           "segmented", "selectr", "seriation", "sessioninfo", 
           "sf", "sftime", "shades", "shape", "shiny", 
           ...
           "visdat", "visreg", "vroom", "waffle", 
           "wakefield", "waldo", "weathermetrics", "whisker", 
           "withr", "wk", "wordcloud", "xfun", "XML", 
           "xml2", "xopen", "xtable", "xts", "yaml", 
           "yulab.utils", "zip", "zoo", "Zseq", 
           "zyp",
...
versions <- c("1.4-5", "1.3-5", "1.21", "0.1.5", 
              ...
              "6.0-94", "1.1.0", "0.6.3", "2.2.4", 
              "2.1.0", "0.72.8", "2.3-60", "0.4.15", 
              "0.2-6", "0.4-95", "7.3-21", "0.4-9", 
              "3.6.1", "3.2-5", "1.1-11", "0.8.0", 
              "0.6.1", "0.3-64", "2.1.4", "3.4.4", 
              "1.2.6", "1.1.12", "0.19-4", "0.2-19", 
              "1.4-2", "1.9.5", "2.3.1", "2.1-0", "1.2.0", 
              "0.0-8", "1.9.0", "2.0.0", "1.0.0", "1.1-12", 
              "0.92", "0.4.4", "1.4.0", "1.1.1", "0.4.3", 
              "1.5.2", "1.3.2", "1.2.0", "2.0.4.6", 
              "5.0.0", "1.25.4", "3.2.15", "1.14.8", 
              "0.1.6", "0.7.1", "1.2-42", "1.1.3", 
              "1.0-6", "1.17.1", "1.0-12", "1.4.2", 
              "0.99.48", "1.35", "1.10", "2.4.5", "1.6.5", 
              "0.3.5", "0.6.31", "1.2-1", "0.3.2", 
              "1.0-2", "0.4.2", "1.1.2", "0.7.4", "0.27", 
              "1.23-1", "1.1.1.6", "1.7-13", "1.5.0", 
              "0.8.2", "0.4.5", "0.3.2", "1.4-0", "1.8.5", 
              "2.7.0", "1.4.1", "0.20", "1.16", "3.2", 
              "0.8-35", "0.999-7", "1.9.1", "0.19", 
              "1.0", "2.1-3", "1.0.7", "2.8", "1.0.4", 
              "1.0.8", "2.1.1", "1.6.3", "1.1.1", "14.1", 
              "1.0.2", "1.1-8", "0.6.2", "1.01-2", 
              "1.1.3.2", "0.5.1", "1.0.0", "1.5.2", 
              "8.21", "0.8-84", "0.2.1", "1.7.1", "1.2-5", 
              "1.5-2", "1.5.2", "1.10.0", "1.32.0", 
              "1.0.0", "1.3.2", "2.0", "0.1.3", "1.1.8", 
              "0.1.1", "1.5-18", "1.9.2", "0.2-2", 
              "2.1.2", "0.4.0", "1.2.1", "0.10.0", 
              "0.4.1", "0.10.4", "0.4.16", "0.3.3", 
              "3.4.2", "0.1.0", "0.5.2", "0.5.2", "0.6.0", 
              "0.9.3", "0.5.4", "3.0.0", "0.2.2", "0.6.4", 
              "0.3.6", "0.1.2", "4.2.4", "0.5.0", "1.4.0", 
              "0.1.2", "2.6.6", "0.1.2", "0.16.2", 
              "1.6.2", "0.7-1", "1.1-2", "1.2-3", "1.0.1", 
              "2.3", "0.5-1", "0.1.5", "2.1-1", "0.8.0", 
              "0.3.3", "0.4.5", "3.9.4", "1.3.0", "2.5.2", 
              "1.4-2", "1.0.1", "1.28.3", "3.1-49", 
              "0.10", "0.8-7", "5.0-1", "1.1.3", "2.4.1", 
              "0.5.5", "1.6.2", "1.6.9", "1.4.5", "0.2.2", 
              "0.4-0", "0.6-0", "1.2-13", "1.4.2", 
              "3.3", "1.0.4", "0.3.1", "0.3.19", "0.19.1", 
              "1.1-4", "0.15.3", "1.0-5", "0.9-14", 
              "1.4", "0.2.7", "1.0.14", "1.0.0", "2.2.0", 
              "0.1-10", "0.1.4", "1.8.4", "0.1.0", 
              "2.2.1", "2.23-20", "1.3.1", "1.7-2", 
              "1.42", "0.4.2", "2.11.0", "10.0-1", 
              "1.3.0", "0.21-8", "0.6-30", "1.7.2.1", 
              "0.2.2", "3.1", "0.4.6", "1.0-9", "1.0.3", 
              "0.9.0", "1.1-32", "3.1-3", "1.7-3", 
              "2.9", "2.4.7", "1.3-1", "0.9-40", "2.6.0", 
              "1.9.2", "0.2-11", "2.7.4", "2.0.3", 
              "2.3.1", "1.2.11", "3.4.1", "1.1-6", 
              "1.6", "7.3-58.3", "1.5-4", "0.5-1", 
              "0.63.0", "0.1-22", "2.0.1", "0.14.0", 
              "1.8-42", "3.15.0", "3.16-18", "0.12", 
              "0.1.1.1", "1.2.5", "2.4", "0.8", "1.1", 
              "2.1-3", "1.1.0", "1.2.2.2", "0.1.11", 
              "0.2-23", "0.5.5", "1.8.4.2", "0.9.2.1", 
              "0.20.3", "1.4-23", "0.1-9", "0.5.0", 
              "1.1-3", "0.3-6", "1.21", "3.1-162", 
              "2.0.3", "7.3-18", "1.0-4", "2016.8-1.1", 
              "1.0.2", "2.16-0", "2.0.6", "4.2.5.2", 
              "1.6.3", "1.5.0", "1.35.0", "0.21.0", 
              "1.2-20", "1.1.2", "1.7-0", "0.5.2", 
              "1.1", "0.5-4.4", "0.10.3", "1.9.0", 
              "2.0.2", "1.4.0", "2.0.3", "2.0.7", "1.3.2", 
              "0.2.0", "4.10.1", "3.8-2", "2.8-1", 
              "1.8.8", "0.1-8", "1.10-4", "1.4-1", 
              "1.4.1", "1.0.0", "0.3.14", "1.1.1", 
              "1.4.0", "1.1.1", "1.18.0", "3.8.1", 
              "2023.03.31", "0.1.1", "0.3.7", "1.2.2", 
              "0.13.0", "1.0-12", "1.2.0.1", "0.4-27", 
              "1.7.5", "1.0.1", "0.1-2", "1.5-8", "0.4.22", 
              "5.95", "0.7.8", "1.0.2", "0.16.0", "1.8.2", 
              "1.25.0", "2.12.2", "2.5.1", "1.2.5", 
              "0.1", "0.3.3", "3.6-20", "0.51.5", "2.2.13", 
              "1.4.0", "1.1-3", "2.0.0", "1.0.10", 
              "0.12.2.0.0", "0.3.3.9.3", "5.1.7", "0.3.0", 
              "1.98-1.12", "2.4", "1.7.0", "2.1.4", 
              "1.4.2", "1.0.5", "0.5-1", "1.0-5", "1.0.1", 
              "2.1.2", "2.4.2", "1.1.6", "0.8.9", "1.4.4", 
              "0.5.29", "1.12.1", "1.1.0", "2.21", 
              "1.3.7", "0.9-1", "0.10.25", "0.95-1", 
              "1.8.2.3", "7.2.3", "4.1.19", "0.3.0", 
              "2.0.3", "2.1.0", "2.3.1", "2.21.7", 
              ...
              "0.6.0", "2.7.0", "1.6.1", "0.7.0", "0.3.6", 
              "0.4.0", "1.2.2", "0.4.1", "2.5.0", "0.7.2", 
              "2.6", "0.39", "3.99-0.14", "1.3.3", 
              "1.0.0", "1.8-4", "0.13.1", "2.3.7", 
              "0.0.6", "2.3.0", "1.8-12", "0.2.1", 
              "0.11-1",
              # mmtable2 package from GitHub added manually to list
              # aida-package package from GitHub added manually to list
              # CDT package from GitHub added manually to list
