...
versions <- c("1.4-5", "1.13", "1.9-3", "0.2.0", "1.1.2", "0.1-3", 
              "1.4.0", "1.66.0-1", "0.1.1", "0.2", "1.0-6", "1.0-4", "1.3-20", 
              ...
              "2.3", "1.3-2", "0.9.2", "1.3.4", "1.0.0", "3.2", "1.22", "3.0-12", 
              "1.10.4-3", "0.8", "1.7.0", "1.0-8", "1.13.5", "2.0-0", "0.6.15", 
              "0.75-7", "1.0-4", "0.9-5.2", "0.7.4", "0.4", "1.5.6", "1.6-8", 
              "4.0-0", "0.4.1", "1.1.2", "2.3.0", "1.3", "0.10.1", "1.12", 
              "2.0-8", "1.0.5", "1.40", "1.0.7", "9.6", "1.0-9", "1.01-2", 
              "2.3-14", "0.3.0", "1.4.4", "0.8-69", "2.1-11", "0.3.0", "2.18.0", 
              "0.1.7", "0.2-2", "1.3.2", "0.1-20", "0.3.2", "0.6.2", "0.4.3", 
              "2.2.1", "0.1.6", "0.7.0", "2.8", "0.4.0", "3.4.0", "0.21.0", 
              "0.2.0", "0.0.13", "1.2.0", "3.0.1", "2.3", "0.2.0", "3.5.0", 
              "1.1.1", "1.3-4", "1.27.2", "0.6", "0.4.2", "1.11.2", "0.3.6", 
              "1.0", "1.3.6.2", "1.3.1", "1.0.9", "0.7.2.9", "1.5", "0.9-25", 
              "2.23-15", "1.20", "0.3", "1.0.1", "6.0-0", "0.20-35", "0.6-28", 
              "0.2.1", "3.0", "1.1-16", "1.2-3", "0.9-35", "1.7.2", "1.5", 
              "2.2-6", "1.2-5", "3.2.0", "0.9-2", "0.8", "7.3-49", "1.2-12", 
              "0.4-1", "5.4", "1.1.0", "0.3.0", "1.8-23", "0.5", "0.1.1", "1.2.4", 
              "1.5-5", "0.1.1", "0.2-21", "1.1.1", "0.4.2", "0.16.0", "1.4-8", 
              "0.4.3", "1.0-7", "0.7.1.295", "0.3-3", "1.16", "3.1-131.1", 
              "1.0.4", "7.3-12", "1.0-4", "0.2.2", "2.3-0", "1.0.1", "4.0.17", 
              "0.4-7", "0.5-4", "1.2.1", "2.0.1", "0.2.0", "4.7.1", "3.7", 
              "1.8.4", "2.2-6", "0.2.0", "1.0.2", "1.1.2", "1.7.8", "0.2.4", 
              "1.2-2", "5.35", "0.6.2", "1.7.1", "1.21.0", "2.2.2", "2.6-7", 
              "1.1-2", "0.12.16", "0.3.3.4.0", "0.2.2", "1.95-4.10", "1.1.1", 
              "1.0.0", "1.0.1", "0.8.7", "1.4.3", "0.5.9", "1.9", "0.2.0", 
              "0.4.6.1", "0.10.14", "1.9-1", "0.92-8", "1.0", "0.7", "0.4-11", 
              "1.3-6", "1.01", "2.4-0", "0.5.0", "0.3-41", "0.4-0", "1.4.4", 
              "1.0.5", "1.5.1", "1.0.8", "2.7.1", "2.4.1", "0.14.2-3", "0.9.1", 
              "0.1.6", "1.2-7", "2.1-3", "1.77", "0.9.4.7", "1.1.7", "1.3.0", 
              "3.33-2", "2.41-3", "1.2.1", "1.0-8", "1.4.2", "0.8.0", "0.2.4", 
              "1.7.13", "0.1-2", "1.1.3", "0.5.0", "0.3.0", "2.5-0", "0.3.0", 
              "0.3-2", "2.1.2", "3.98-1.10", "1.8-2", "2.1.18", "1.8-1")
