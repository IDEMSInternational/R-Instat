...
load_R_Instat_packages <- function() {
  ...
  # texmex because etremes distribution functions are needed in mosaic functions used
...
packs <- c("abind", "agricolae", "agridat", 
           ...
           "askpass", "assertthat", "backports", "base64enc", 
           "bayestestR", "BH", "BiocManager", "bitops", 
           "boot", "brew", "brio", "broom", "bslib", 
           "cachem", "callr", "candisc", "car", 
           "carData", "cellranger", "changepoint", "checkmate", 
           "chillR", "chron", "circlize", "CircStats", 
           "circular", "class", "classInt", "cli", 
           "clifro", "climdex.pcic", "clipr", "cluster", 
           "cmsaf", "cmsafops", "cmsafvis", "colorRamps", 
           "colorspace", "colourpicker", "combinat", "commonmark", 
           "conquer", "corrplot", "countrycode", "covr", 
           "cowplot", "cpp11", "crayon", "credentials", 
           "crosstalk", "curl", "DAAG", "dae", "data.table", 
           "date", "DBI", "dendextend", "DEoptimR", 
           "desc", "DescTools", "devtools", "diffobj", 
           "digest", "distillery", "dotCall64", "dplyr", 
           "DT", "dummies", "e1071", "ecmwfr", "effectsize", 
           ...
           "gridExtra", "gridGraphics", "gridtext", "gtable", 
           ...
           "reshape", "reshape2", "rex", "rgdal", 
           "rio", "rje", "rlang", "rlist", "RMAWGEN", 
           "RMySQL", "robustbase", "rootSolve", "roxygen2", 
           "rpart", "rprojroot", "rrefine", "rstatix", 
           "rstudioapi", "rtf", "Rttf2pt1", "rvcheck", 
           "rversions", "rvest", "rworldmap", "rworldxtra", 
           "sandwich", "sass", "scales", "scatterplot3d", 
           "SearchTrees", "selectr", "sessioninfo", "sf", 
           "shades", "shape", "shiny", "shinyFiles", 
           "shinyjs", "shinythemes", "signmedian.test", 
           "sjlabelled", "sjmisc", "sjPlot", "sjstats", 
           "sodium", "sourcetools", "sp", "spam", 
           "SparseM", "SPEI", "splus2R", "statmod", 
           ...
           "timeDate", "treemapify", "trend", "tseries", 
           "TTR", "tweenr", "units", "urca", "usethis", 
...
versions <- c("1.4-5", "1.3-3", "1.18", "1.2.0", 
              ...
              "1.2.1", "0.1-3", "0.8.2", "1.75.0-0", 
              "1.30.10", "1.0-6", "1.3-27", "1.0-6", 
              "1.1.1", "0.7.5", "0.2.4", "1.0.4", "3.5.1", 
              "0.8-5", "3.0-10", "3.0-4", "1.1.0", 
              "2.2.2", "2.0.0", "0.72.2", "2.3-56", 
              "0.4.12", "0.2-6", "0.4-93", "7.3-18", 
              "0.4-3", "2.3.1", "3.2-3", "1.1-11", 
              "0.7.1", "2.1.1", "3.1.0", "1.1.1", "1.1.1", 
              "2.3", "2.0-0", "1.1.0", "0.0-8", "1.7", 
              "1.0.2", "0.84", "1.2.0", "3.5.1", "1.1.1", 
              "0.2.6", "1.4.1", "1.3.0", "1.1.1", "4.3", 
              "1.24", "3.1-37", "1.14.0", "1.2-39", 
              "1.1.1", "1.14.0", "1.0-8", "1.3.0", 
              "0.99.40", "2.3.2", "0.3.4", "0.6.27", 
              "1.2", "1.0-1", "1.0.5", "0.17", "1.5.6", 
              "1.7-6", "1.3.0", "0.4.4", "0.4.2", "0.3.1", 
              "1.5.5-1", "2.4.0", "1.3", "0.14", "1.15", 
              "2.1", "0.999-6", "1.9.1", "0.17", "1.0", 
              "2.1", "1.0.7", "2.4", "0.4.2", "1.0.7", 
              "2.1.0", "1.1.0", "11.6", "1.0.2", "1.1-3", 
              "1.01-2", "1.1.3", "0.5.1", "8.14", "0.8-81", 
              "1.2-4", "1.5-1", "1.5.0", "0.3.0", "0.1.0", 
              "1.1.7", "1.5-10", "1.2.0", "0.2-2", 
              "2.1.1", "0.4.0", "0.1.22", "1.0.2", 
              "0.9.1", "0.3.3", "0.10.1", "0.4.11", 
              "0.3.3", "3.3.3", "0.0.5", "0.3.8-1", 
              "0.4.0", "0.9.1", "0.5.3", "2.9", "0.6.1", 
              "0.3.5", "0.1.1", "4.2.4", "1.2.0", "0.1.1", 
              "2.6.2", "0.1.2", "1.4.2", "0.6-2", "1.2-2", 
              "2.3", "0.5-1", "0.1.4", "0.3.0", "2.3.1", 
              "1.3-8", "1.28.2", "0.8", "4.5-0", "1.0.0", 
              "2.1.0", "0.5.1.1", "1.5.3", "1.5.5", 
              "1.4.2", "3.2", "0.3.1", "0.13.1", "0.2.4", 
              "0.1-8.1", "0.1.3", "1.7.2", "2.2", "2.23-18", 
              "1.1.0", "0.6-15", "1.31", "0.4.2", "2.8.0", 
              "8.0-1", "1.1.0.1", "0.20-41", "0.6-29", 
              "0.2.2", "1.9.0", "2.0.4.1", "3.1", "1.0.0", 
              "1.1-26", "2.8", "2.3.6", "1.3-1", "0.9-38", 
              "1.7.10", "2.7.1", "2.0.1", "2.3.0", 
              "1.2.7", "3.3.0", "1.1-1", "1.1", "7.3-53.1", 
              "1.2-18", "0.5-0", "0.58.0", "2.0.0", 
              "1.8-34", "0.10", "0.1.1.1", "1.2.4", 
              "0.6", "0.6", "0.1.8", "1.8.3", "0.9.0", 
              "0.20.2", "0.5.0", "1.1-1", "0.3-5", 
              "1.17", "3.1-152", "1.2.2.2", "7.3-15", 
              "1.0-4", "2016.8-1.1", "1.0.1", "2.8-3", 
              "1.4.3", "4.2.3", "0.12.0", "1.1.1", 
              "0.5.1", "1.1", "0.5-4.1", "0.7.0", "1.5.1", 
              "1.2.0", "2.0.3", "1.2.0", "4.9.3", "3.8-1", 
              "2.7-3", "1.8.6", "0.1-7", "1.10-0", 
              "1.4-0", "1.0.0", "1.1.1", "3.5.0", "0.1.1", 
              "1.2.2", "1.0-10.1", "1.2.0.1", "0.4-25", 
              "1.6.0", "0.3.4", "1.5-8", "0.4.18", 
              "5.85", "0.7.4", "0.14.0", "1.8.1", "1.24.0", 
              "2.10.1", "2.5.0", "0.1", "0.3.3", "3.4-5", 
              "0.50.1", "1.3.3", "1.1-2", "1.0.6", 
              "0.10.2.2.0", "0.3.3.9.1", "0.3.0", "1.98-1.3", 
              "1.7.0", "1.4.0", "1.3.1", "1.0.1", "2.1.2", 
              "2.2.0", "0.8.8", "1.4.4", "1.2.0", "1.5-23", 
              "0.5.26", "1.10.16", "0.4.10", "0.4.6.1", 
              "1.3.7", "0.10.21", "0.93-7", "1.8.2.1", 
              "7.1.1", "4.1-15", "2.0.2", "1.1.0", 
              "0.7.0", "0.13", "0.4-14.1", "1.3.8", 
              "0.1.8", "2.0.2", "1.0.0", "1.3-6", "1.01", 
              "3.0-0", "0.3.1", "1.1.1", "0.3-41", 
              "0.5.2", "0.4-2", "1.1.1", "0.9-8", "1.4.0", 
              "1.4.5", "1.6.0", "0.9.0", "2.0.0", "1.2.0", 
              "1.5.1", "1.1.7", "2.8.6", "2.8.7", "0.18.1", 
              "1.1", "0.1.7", "1.4-5", "2.6-0", "1.81", 
              "1.7", "1.3-3", "1.4.35", "1.4", "0.9.6.3", 
              "1.5.3", "1.4.0", "1.5-2", "1.4.0", "3.2-10", 
              "2.0.0", "3.4", "1.0.1", "1.1-4", "3.0.2", 
              "2.4.8", "3.1.0", "1.1.3", "1.1.0", "3043.102", 
              "2.5.5", "1.1.4", "0.10-48", "0.24.2", 
              "1.0.2", "0.7-1", "1.3-0", "2.0.1", "1.2.1", 
              "1.5-3", "0.3.6", "0.5.1", "0.3.0", "0.5.3", 
              "2.7.0", "0.3.6", "0.2.5", "1.2.2", "0.4", 
              "2.4.1", "0.22", "3.99-0.6", "1.3.2", 
...
versions <- c("1.4-5", "1.3-3", "1.18", "1.2.0", 
              ...
              "1.75.0-0", "1.30.12", "1.0-7", "1.3-27", 
              "1.0-6", "1.1.2", "0.7.6", "0.2.4", "1.0.4", 
              "3.7.0", "0.8-5", "3.0-10", "3.0-4", 
              "1.1.0", "2.2.2", "2.0.0", "0.72.2", 
              "2.3-56", "0.4.12", "0.2-6", "0.4-93", 
              "7.3-18", "0.4-3", "2.5.0", "3.2-3", 
              "1.1-11", "0.7.1", "2.1.2", "3.1.0", 
              "1.1.1", "1.1.1", "2.3", "2.0-0", "1.1.0", 
              "0.0-8", "1.7", "1.0.2", "0.84", "1.2.0", 
              "1.1.1", "0.2.7", "1.4.1", "1.3.0", "1.1.1", 
              "4.3.1", "1.24", "3.1-37", "1.14.0", 
              "1.2-39", "1.1.1", "1.14.0", "1.0-8", 
              "1.3.0", "0.99.41", "2.4.0", "0.3.4", 
              "0.6.27", "1.2", "1.0-1", "1.0.5", "0.18", 
              "1.5.6", "1.7-6", "1.3.0", "0.4.4-1", 
              "0.4.2", "0.3.1", "1.6.0", "2.4.0", "1.3", 
              "0.14", "1.15", "2.1", "0.999-6", "1.9.1", 
              "0.17", "1.0", "2.1", "1.0.7", "2.4", 
              "0.4.2", "1.0.7", "2.1.0", "1.1.0", "11.6", 
              ...
              "0.9", "4.5-0", "1.0.0", "2.1.0", "0.5.1.1", 
              "1.5.3", "1.6.0", "1.4.2", "0.4-0", "0.6-0", 
              "3.2", "0.3.1", "0.13.2", "0.15.2", "0.2.4", 
              "0.1-8.1", "0.1.4", "1.7.2", "2.2", "2.23-18", 
              "1.2.0", "0.6-15", "1.33", "0.4.2", "2.8.0", 
              "9.0-0", "1.2.0", "0.20-41", "0.6-29", 
              "0.2.2", "1.9.0", "2.0.4.1", "3.1", "1.0.0", 
              "1.1-26", "2.8", "2.3.6", "1.3-1", "0.9-38", 
              "1.7.10", "2.7.1", "2.0.1", "2.3.0", 
              "1.2.7", "3.3.0", "1.1-1", "1.1", "7.3-53.1", 
              ...
              "0.5.1", "1.1", "0.5-4.1", "0.7.1", "1.6.0", 
              "1.2.0", "2.0.3", "1.2.1", "4.9.3", "3.8-1", 
              "2.7-3", "1.8.6", "0.1-7", "1.10-0", 
              "1.4-0", "1.0.0", "1.1.1", "3.5.1", "0.1.1", 
              "1.2.2", "1.0-10.1", "1.2.0.1", "0.4-25", 
              "1.6.0", "0.3.4", "1.5-8", "0.4.18", 
              ...
              "1.81", "1.7", "1.3-3", "1.4.35", "1.4", 
              "0.9.6.3", "1.5.3", "1.4.0", "1.5-2", 
              "1.4.1", "3.2-11", "2.0.0", "3.4", "1.0.1", 
              "1.2-5", "3.0.2", "2.4.8", "3.1.1", "1.1.3", 
              "1.1.1", "3043.102", "2.5.5", "1.1.4", 
              "0.10-48", "0.24.2", "1.0.2", "0.7-1", 
              "1.3-0", "2.0.1", "1.2.1", "1.5-3", "0.3.7", 
              "0.6.0", "0.4.0", "0.5.3", "2.7.0", "0.3.6", 
              "0.2.5", "1.2.2", "0.4", "2.4.2", "0.22", 
              "3.99-0.6", "1.3.2", "1.0.0", "1.8-4", 
              "0.12.1", "2.2.1", "2.1.1", "1.8-9", 
              "0.10-1.1")
