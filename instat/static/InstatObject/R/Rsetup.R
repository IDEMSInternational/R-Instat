...
packs <- c("abind", "acepack", "agricolae", 
           ...
           "stringdist", "stringi", "stringr", "survival",
           "svglite", "sys", "systemfonts", "testthat",
           "tibble", "tidyr", "tidyselect", "translations",
           "treemapify", "units", "usethis", "utf8",
           "vctrs",  "verification", "viridis", "viridisLite",
           "visreg", "wakefield", "weathermetrics", "whisker",
           "withr", "xfun", "XML", "xml2",
           "xopen", "xtable", "xts", "yaml",
           "zip", "zoo")
...
versions <- c("1.4-5", "1.4.1", "1.3-2", "1.16", 
              ...
              "0.1.7", "1.3-2", "1.2-3", "2.5-1",
              "1.78", "7.3-11", "1.7", "1.2-2",
              "0.9.6", "1.4.4", "1.4.0", "3.1-8",
              "1.2.2", "3.3", "0.1.1", "2.3.1", 
              "2.1.3", "1.0.2", "0.2.5", "3.6.2",
              "2.5.3", "0.6-5", "1.5.1", "1.1.4",
              "0.2.2", "1.42", "0.5.1", "0.3.0",
              "2.6-0", "0.3.3", "1.2.2", "0.4",
              "2.1.2", "0.12", "3.99-0.3", "1.2.2", 
