...
packs <- c("abind", "acepack", "agricolae", 
           ...
           "digest", "diptest", "distillery", "dotCall64", 
           "dplyr", "dummies", "e1071", "ellipse", 
           "ellipsis", "emmeans", "EnvStats", "estimability", 
           "evaluate", "Evapotranspiration", "expm", "extrafont", 
           "extrafontdb", "extRemes", "factoextra", "FactoMineR", 
           "fansi", "faraway", "fields", "fitdistrplus", 
           "flashClust", "flexmix", "forcats", "foreach", 
           "foreign", "Formula", "fpc", "fs", "gapminder", 
           "gdata", "gdtools", "generics", "geosphere", 
           "getPass", "GGally", "ggalt", "ggdendro", 
           "ggeffects", "ggformula", "ggfortify", "ggmosaic", 
           ...
           "jsonlite", "kernlab", "KernSmooth", "klaR", 
           "knitr", "labeling", "labelled", "Lahman", 
           "later", "lattice", "latticeExtra", "lazyeval", 
           "leaflet", "leaps", "LearnBayes", "lme4", 
           "lmomco", "Lmoments", "lsei", "lubridate", 
           "magrittr", "mapdata", "mapproj", "maps", 
           "maptools", "markdown", "MASS", "Matrix", 
           "MatrixModels", "mclust", "memoise", "mgcv", 
           "mime", "miniUI", "minqa", "mnormt", 
           "modelr", "modeltools", "mosaic", "mosaicCore", 
           ...
           "pbkrtest", "PCICt", "performance", "pillar", 
           "pkgbuild", "pkgconfig", "pkgload", "plogr", 
           "plotly", "plotrix", "plyr", "png", "polynom", 
           "prabclus", "prettyunits", "processx", "productplots", 
           ...
           "spData", "spdep", "SPEI", "stringi", 
           "stringr", "survival", "svglite", "sys", 
           "tibble", "tidyr", "tidyselect", "TMB", 
           "trimcluster", "units", "usethis", "utf8", 
           "viridis", "viridisLite", "visreg", "wakefield", 
           "weathermetrics", "whisker", "withr", "xfun", 
           "XML", "xml2", "xopen", "xtable", "yaml", 
           "zip", "zoo")
  
versions <- c("1.4-5", "1.4.1", "1.3-1", "1.16", 
              "1.1-7.3", "1.0-15", "1.1", "0.2.1", 
              "1.1.4", "0.1-3", "0.1.0", "1.69.0-1", 
              "1.0-6", "1.3-22", "0.5.2", "3.2.0", 
              "0.8-0", "3.0-2", "3.0-2", "1.17.1.2", 
              ...
              "1.3.4", "1.0.0", "3.3", "1.22.1", "3.0-23", 
              "1.12.2", "1.0.0", "0.1-16", "1.10.0", 
              "1.0-8", "1.2.0", "2.0.2", "0.6.18", 
              "0.75-7", "1.0-6", "1.0-0", "0.8.0.1", 
              "1.5.6", "1.7-1", "0.4.1", "0.1.0", "1.3.4", 
              "2.3.1", "1.3", "0.13", "1.13", "0.999-4", 
              "0.17", "1.0", "2.0-10", "1.0.5", "1.41", 
              "0.4.0", "1.0.7", "9.7", "1.0-14", "1.01-2", 
              "2.3-15", "0.4.0", "1.4.4", "0.8-71", 
              "1.2-3", 
              # manually reduced required 'fpc' version from 2.1-11.2 to 2.1-11.1
              # 2.1-11.2 only available for R 3.6.0
              "2.1-11.1", 
              "1.3.1", "0.3.0", 
              "2.18.0", "0.1.8", "0.0.2", "1.5-7", 
              "0.2-2", "1.4.0", "0.4.0", "0.1-20", 
              "0.9.0", "0.9.1", "0.4.6", "0.2.0", "3.1.1", 
              "0.2", 
              # manually reduced required 'ggrepel' version from 0.8.1 to 0.8.0
              # binaries not yet available for 0.8.1
              "0.8.0", 
              "2.9", "0.5.0", "0.3.1", 
              "4.1.1", "1.0.1", "0.25.2", "0.2.3", 
              "0.1.0", "1.3.1", "2.18.1", "1.1-1", 
              "3.0.1.1", "2.3", "0.3.0", "3.8.1", "2.1.0", 
              "1.3-5", "1.27.2", "0.8", "4.2-0", "0.4.2", 
              "1.13.1", "0.3.6", "1.3", "1.5.1", "1.4.0", 
              "0.3.1", "0.2.0", "1.0.10", "0.7.2.9", 
              "1.6", "0.9-27", "2.23-15", "0.6-14", 
              "1.22", "0.3", "2.2.0", "7.0-1", "0.8.0", 
              "0.20-38", "0.6-28", "0.2.2", "2.0.2", 
              "3.0", "2.15.1", "1.1-21", "2.3.2", "1.3-1", 
              "1.2-0", "1.7.4", "1.5", "2.3.0", "1.2.6", 
              "3.3.0", "0.9-5", "0.9", "7.3-51.4", 
              "1.2-17", "0.4-1", "5.4.3", "1.1.0", 
              "1.8-28", "0.6", "0.1.1.1", "1.2.4", 
              "1.5-5", "0.1.4", "0.2-22", "1.5.0", 
              "0.6.0", "0.17.0", "0.5.0", "1.0-10", 
              "0.7.1.295", "0.3-3", "1.16.1", 
              # manually reduced required 'nlme' version from 3.1-139 to 3.1-137
              # binaries not yet available for 3.1-139
              "3.1-137", 
              "1.2.1", "7.3-12", "1.0-4", "0.4-0", 
              "2016.8-1", "1.0.0", "2.6-5", "1.3", 
              "4.1.0", "0.4-7", "0.5-4.1", "0.1.0", 
              "1.3.1", "1.0.3", "2.0.2", "1.0.2", "0.2.0", 
              "4.9.0", "3.7-5", "1.8.4", "0.1-7", "1.4-0", 
              "2.2-7", "1.0.2", 
              # manually reduced required 'processx' version from 3.3.1 to 3.3.0
              # binaries not yet available for 3.3.1
              "3.3.0", 
              "0.1.1", "1.2.0", 
              "1.0-8", "1.0.1", "1.3.0", "1.8.12", 
              "0.3.2", "5.38", "0.7.0", "1.7.1", "1.22.0", 
              "2.4.0", "2.8-19", "1.3.3", "1.1-2", 
              "1.0.1", "0.9.400.2.0", "0.3.3.5.0", "0.3.0", 
              "1.95-4.12", "1.6.7", "1.3.1", "1.3.1", 
              "1.0.1", "2.0.4", "0.8.8", "1.4.3", "0.5.16", 
              "1.9", "0.3.4", "0.4.6.1", "0.10.17", 
              "1.9-1", "0.93-4", "4.1-15", "1.3-2", 
              "1.0", "0.10", "0.4-13", "1.3.7", "1.3-6", 
              "1.01", "1.0.0", "0.3-41", "1.1.1", "0.7-4", 
              "1.4.4", "1.3.2", "1.5.1", "1.0.17", 
              "2.7.9", "2.6.3", "0.17.4", "0.1.7", 
              "1.3-1", "2.2-2", "1.77", "0.3.0", "1.1-2", 
              "1.7", "1.4.3", "1.4.0", "2.44-1.1", 
              "1.2.1", "3.2", "2.1.1", "0.8.3", "0.2.5", 
              "1.7.15", "0.1-2.1", "0.6-3", "1.5.0", 
              "1.1.4", "0.5.1", "0.3.0", "2.5-0", "0.3.3", 
              "1.2.2", "0.3-2", "2.1.2", "0.6", "3.98-1.19", 
              "1.2.0", "1.0.0", "1.8-4", "2.2.0", "2.0.1", 
              "1.8-5")
