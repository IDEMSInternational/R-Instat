...
versions <- c("1.4-5", "1.3-5", "1.20", "1.2.0", 
            ...
            "1.2.0", "4.3.2", "1.24", "3.2-13", "1.14.2", 
            "0.4.0", "1.2-39", "1.1.2", "1.15.2", 
            "1.0-11", "1.4.1", "0.99.45", "2.4.3", 
            "0.3.5", "0.6.29", "1.2-1", "1.0-1", 
            "1.0.9", "0.7.4", "0.23", "1.7-9", "1.3.0", 
            "0.6.0.1", "0.4.2", "0.3.2", "1.7.3", 
            ...
            "5.93", "0.7.7", "0.15.0", "1.8.1", "1.24.0", 
            "2.11.0", "2.5.1", "0.1", "0.3.3", "3.5-15", 
            "0.51.2", "1.4.0", "1.1-3", "2.0.0", 
            "1.0.8.3", "0.11.0.0.0", "0.3.3.9.2", "0.3.0", 
            "1.98-1.6", "1.7.0", "2.1.2", "1.4.0", 
            "0.2.0", "0.5-1", "1.0.1", "2.1.2", "2.4.2", 
            "1.1.4", "0.8.9", "1.4.4", "1.5-32", 
            "0.5.29", "1.10.16", "1.0.2", "1.3.7", 
            "0.10.23", "0.95-0", "1.8.2.3", "7.1.2", 
            "4.1.16", "0.3.0", "2.0.3", "2.0.0", 
            "0.7.0", "0.13", "0.4-14.1", "1.3.10", 
            "2.1.1", "1.0.2", "1.3-6", "1.01", "1.0.7", 
            "3.0-1", "0.4.1", "1.2.0", "0.3-41", 
            "0.5.2", "0.4-2", "1.3.5", "1.2.2", "1.0-7", 
            "1.4.0", "1.4.6", "1.7.1", "0.9.1", "2.1.0", 
            "1.2.0", "0.6.4", "1.5.1", "1.2.0", "2.8.9", 
            "2.8.10", "0.18.1", "2.1.4", "0.11.0", 
            "0.7.0", "1.2.0", "0.1.7", "1.4-7", "1.2-6", 
            "2.8-0", "1.81", "1.7", "0.4.5", "1.3-3", 
            "2021.1", "0.2.3", "1.4", "0.9.8", "1.7.6", 
            "1.4.0", "1.5-2", "1.7.0", "3.3-1", "2.1.0", 
            "3.4", "1.0.4", "1.5-21", "3.1.4", "2.4.8", 
            "3.1.7", "1.2.0", "1.1.2", "0.3.3", "3043.102", 
            "0.2.1", "2.5.5", "1.1.4", "0.10-51", 
            "1.2-0", "0.24.3", "1.0.2", "0.3.0", 
            "0.8-0", "1.3-0", "2.1.5", "1.2.2", "1.5-6", 
            "0.4.1", "0.6.2", "0.4.0", "0.5.3", "2.7.0", 
            "1.5.7", "0.3.6", "0.4.0", "1.2.2", "0.4", 
            "2.5.0", "0.6.0", "0.31", "3.99-0.9", 
