...
packs <- c("reshape2", "lubridate", "plyr", "dplyr", "rtf", "openxlsx", 
           ...
           "sjmisc", "plotly", "svglite", "Rcpp", "stringi", "magrittr", 
           "assertthat", "tibble", "BH", "R.oo", "R.methodsS3", "digest", 
           "gtable", "MASS", "scales", "RColorBrewer", "dichromat", "munsell", 
           "labeling", "colorspace", "Lmoments", "distillery", "car", "mgcv", 
           "nnet", "pbkrtest", "quantreg", "nlme", "Matrix", "SparseM", 
           "MatrixModels", "lattice", "minqa", "nloptr", "RcppEigen", "progress", 
           "reshape", "prettyunits", "latticeExtra", "cluster", "ellipse", 
           "flashClust", "leaps", "scatterplot3d", "knitr", "evaluate", 
