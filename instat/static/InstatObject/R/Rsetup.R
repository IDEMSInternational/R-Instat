...
packs <- c("abind", "agricolae", "agridat", "agriTutorial", 
           ...
           "gdata", "generics", "GenSA", "geomtextpath", "gert", "getPass", 
           ...
           "nanonext", "ncdf4.helpers", "ncdf4", "nlme", "nloptr", "nnet", 
           "nortest", "numDeriv", "nycflights13", "openair", "openssl", 
           "openxlsx", "operator.tools", "ordinal", "paletteer", "pan", 
           "parallelly", "parameters", "partykit", "patchwork", "pbapply", 
           "pbkrtest", "pbs", "PCICt", "performance", "permute", "pillar", 
           "pingr", "pkgbuild", "pkgconfig", "pkgdown", "pkgload", "plogr", 
           "plotly", "plotrix", "pls", "plyr", "png", "polynom", "posterior", 
           "praise", "prediction", "prettyunits", "primes", "prismatic", 
           "pROC", "processx", "prodlim", "productplots", "profvis", "progress", 
           "progressr", "proj4", "promises", "proxy", "ps", "purrr", "qap", 
           "quadprog", "quantmod", "quantreg", "questionr", "QuickJSR", 
           ...
           "RcppEigen", "RcppParallel", "RcppRoll", "RCurl", "Rdpack", "reactable", 
           "reactR", "readODS", "readr", "readxl", "recipes", "reformulas", 
           "registry", "relimp", "rematch", "rematch2", "remotes", "repr", 
           "reshape", "reshape2", "rgl", "rio", "rje", "rlang", "rmarkdown", 
           "RMAWGEN", "Rmpfr", "RMySQL", "robustbase", "rootSolve", "roxygen2", 
           "rpart", "rpivotTable", "rprojroot", "rrefine", "RSQLite", "rstan", 
           "rstanarm", "rstantools", "rstatix", "rstudioapi", "rtf", "Rttf2pt1", 
           "rversions", "rvest", "rworldmap", "rworldxtra", "s2", "sandwich", 
           "sass", "scales", "scatterplot3d", "SearchTrees", "segmented", 
           "selectr", "seriation", "sessioninfo", "shades", "shape", "shiny", 
           ...
           "textshaping", "TH.data", "threejs", "tibble", "tidyr", "tidyselect", 
           ...
           "Weighted.Desc.Stat", "weights", "whisker", "withr", "wk", "wordcloud", 
           "writexl", "xfun", "XML", "xml2", "xopen", "xtable", "xts", "yaml", 
           "yulab.utils", "zip", "zoo", "Zseq", "zyp",
...
versions <- c("1.4-8", "1.3-7", "1.24", "0.1.5", "1.2.1.1", "2.8.235", 
              ...
              "0.9.12-4.7", "1.11.1", "0.15.2", "1.87.0-1", "0.3.0", "4.6.0", 
              ...
              "0.8.0", "0.7.2", "0.3-66", "2.1.8.1", "3.5.2", "1.4.0", "1.2.9", 
              "0.19-4.1", "0.2-20", "1.4-3", "2.1.0", "2.3.4", "2.1-1", "1.3.0", 
              "1.9.5", "2.0.0", "1.0.2", "1.1-12", "0.95", "0.4.4", "1.6.0", 
              "1.1.3", "0.5.2", "1.5.3", "2.0.2", "1.2.1", "2.1.1", "6.2.1", 
              "1.25.6", "3.2.30", "1.17.0", "0.1.9", "1.0.1", "1.2-42", "1.2.3", 
              ...
              "1.0.9", "2.1.2", "1.7.5", "1.2.0", "16.3.1", "1.0.3", "1.2-2", 
              "0.6.2", "1.01-2", "1.1.4.1", "0.5.3", "1.0.0", "1.5.2", "8.23.0", 
              "0.8-88", "0.2.1", "1.7.1", "1.2-5", "1.5-3", "1.6.5", "1.11.3", 
              "1.34.0", "1.0.0", "1.3.2", "2.0", "3.0.1", "0.1.3", "1.1.14.1", 
              "0.1.5", "2.1.4", "0.2-4", "2.2.1", "0.4.0", "2.2.1", "0.10.2", 
              "0.12.0", "0.4.17", "0.3.3", "3.5.1", "0.1.2", "0.6.1", "0.5.8-1", 
              "0.6.0", "0.9.6", "0.5.6", "3.2.0", "0.3.1", "0.6.4", "0.9.0", 
              "0.1.2", "5.1.0", "0.6.2", "1.4.1", "0.1.2", "2.6.7", "4.1-8", 
              "0.1.2", "0.16.3", "1.8.0", "0.7-5", "1.1-5", "1.2-3", "1.0.2", 
              "2.3", "0.5-1", "0.1.5", "0.11.1", "0.3.6", "0.5.0", "3.9.5", 
              "1.4.1", "2.5.4", "1.7.3", "1.0.1", "1.28.5", "3.1-53", "0.11", 
              "0.9-1", "5.2-3", "1.1.3", "2.4.3", "0.5.8.1", "1.6.4", "1.6.15", 
              "1.4.7", "1.1.1", "0.6-0.1", "0.7-0.1", "1.2-13", "2.1.4", "3.3", 
              "1.0.7", "0.3.1", "0.3.21", "1.1.0", "1.1-6", "1.0-5", "0.9-15", 
              "1.4", "0.2.7", "1.0.14", "1.0.0", "2.2.1", "2.7-6", "0.1-10", 
              "0.1.4", "1.9.1", "0.1.0", "2.2.1", "2.23-26", "1.3.2", "1.50", 
              ...
              "1.9.4", "2.0.3", "2.3.1", "1.2.11", "3.4.2.1", "1.13", "7.3-65", 
              "1.7-3", "0.5-3", "1.5.0", "0.2.1", "2.0.1", "0.18.0", "1.9-1", 
              "3.17.0", "3.17-44", "1.5.0", "0.13", "0.1.1.1", "1.2.8", "0.0.5", 
              "0.4-5", "2.4", "0.8", "1.2", "2.1-6", "1.4.0", "1.2.2.2", "0.1.11", 
              "0.2-23", "0.7.0", "1.9.1", "0.9.4.0", "0.20.4", "1.4-28", "0.1-10", 
              "0.5.1", "1.3-3", "1.5.2", "0.3-7", "1.23", "3.1-167", "2.2.1", 
              "7.3-20", "1.0-4", "2016.8-1.1", "1.0.2", "2.18-2", "2.3.2", 
              "4.2.8", "1.6.3", "2023.12-4.1", "1.6.0", "1.9", "1.42.0", "0.24.2", 
              "1.2-23", "1.3.0", "1.7-2", "0.5.3", "1.1", "0.5-4.4", "0.13.0", 
              "0.9-7", "1.10.1", "2.0.5", "1.4.6", "2.0.3", "2.1.1", "1.4.0", 
              "0.2.0", "4.10.4", "3.8-4", "2.8-5", "1.8.9", "0.1-8", "1.4-1", 
              "1.6.1", "1.0.0", "0.3.18", "1.2.0", "1.6.1", "1.1.2", "1.18.5", 
              "3.8.6", "2024.06.25", "0.1.1", "0.4.0", "1.2.3", "0.15.1", "1.0-14", 
              "1.3.2", "0.4-27", "1.9.0", "1.0.4", "0.1-2", "1.5-8", "0.4.26", 
              "6.1", "0.7.8", "1.6.0", "1.0.4", "0.16.0", "1.8.2", "1.27.0", 
              "2.13.0", "2.6.1", "1.3.3", "0.1", "0.3.3", "3.6-31", "0.51.6", 
              "2.3", "1.4.0", "1.1-3", "2.0.1", "1.0.14", "14.4.0-1", "0.3.4.0.2", 
              "5.1.10", "0.3.1", "1.98-1.16", "2.6.3", "0.4.4", "0.6.1", "2.3.2", 
              "2.1.5", "1.4.5", "1.2.0", "0.4.0", "0.5-1", "1.0-5", "2.0.0", 
              ...
              "2.32.6", "2.32.1", "2.4.0", "0.7.2", "0.17.1", "0.4-14.1", "1.3.12", 
              "2.1.2", "1.0.4", "1.3-8", "1.01", "1.1.7", "3.1-1", "0.4.9", 
              "1.3.0", "0.3-44", "0.5.5", "2.1-4", "0.4-2", "1.5.7", "1.2.3", 
              "1.4.0", "1.4.6.1", "1.10.0", "0.9.3", "2.1.0", "2.6.0", "1.2.0", 
              "0.9.0", "1.2.0", "2.8.10", "2.8.17", "0.19.0", "2.1.5", "0.11.1", 
              "0.7.1", "1.4.0", "0.1.7-1", "2.2-0", "2.11-1", "1.84-2", "0.3.1", 
              "1.8.1", "0.5.4", "1.3-5", "2021.1", "2.32.10", "0.2.3", "0.3.2", 
              "0.3.0", "1.5", "0.9.15", "1.8.4", "1.5.1", "1.5-4", "1.10.3", 
              "3.8-3", "2.1.3", "3.4.3", "1.2.1", "0.36.2.1", "1.8-29", "3.2.3", 
              ...
              "0.8-7", "1.3-4", "1.0.1", "3.1.0", "1.2.4", "6.0.2", "1.6-1", 
              "1.4-13", "0.8-5", "0.6.5", "2.6-10", "1.44", "0.6.5", "0.4.2", 
              "0.6.0", "2.7.0", "1.6.5", "1.0.2", "0.3.6", "0.6.1", "1.2.2", 
              "1.0", "1.0.4", "0.4.1", "3.0.2", "0.9.4", "2.6", "1.5.2", "0.51", 
