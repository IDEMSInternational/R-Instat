...
packs <- c("abind", "agricolae", "agridat", "AlgDesign", "animation", 
        ...
        "pls", "plyr", "png", "polyclip", "polynom", "praise", "prediction" ,"prettyunits", 
        ...
        "SearchTrees", "segmented", "selectr", "seriation", "sessioninfo", "sf", "sftime", 
        ...
        "usethis", "utf8", "vars", "vcd", "vcdExtra", "vctrs", "verification", "viridis", 
