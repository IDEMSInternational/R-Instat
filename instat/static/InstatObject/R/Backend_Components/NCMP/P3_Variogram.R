...
# ne: which index to compute variogram for, 1 to 8.
...
p3_variogram <- function(p2, station, year, month, nyb = 1981, nye = 2010, ne,
  ...
  # DP How should we do configuration files for R-Instat?
