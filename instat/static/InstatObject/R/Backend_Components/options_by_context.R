...
obyc_all_types <- c(option_1_label, option_other_label, context_1_label, context_2_label, context_3_label, context_4_label, context_other_label, measurement_1_label, measurement_other_label, id_1_label, id_other_label)
...
data_object$set("public","set_options_by_context_types", function(obyc_types = NULL, key_columns = NULL) {
  ...
  other_cols <- dplyr::setdiff(x = self$get_column_names(), y = obyc_types)
