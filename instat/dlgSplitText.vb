...
Public Class dlgSplitText
    ...
    Private Sub InitialiseDialog()
        ...
        ucrInputColumnIntoText.SetPrefix("splitText")
        ucrReceiverSplitTextColumn.SetDataType("factor")
        ucrInputColumnIntoText.SetItemsTypeAsColumns()
        ucrInputColumnIntoText.SetDefaultTypeAsColumn()
        ucrInputColumnIntoText.SetDataFrameSelector(ucrSelectorSplitTextColumn.ucrAvailableDataFrames)
    ...
    Private Sub SetDefaults()
        ...
        ucrInputColumnIntoText.cboInput.ResetText()
    End Sub
    ...
    Private Sub ucrInputColumnInto_NameChanged()
        ucrBase.clsRsyntax.SetAssignTo(strAssignToName:=ucrInputColumnIntoText.GetText, strTempDataframe:=ucrSelectorSplitTextColumn.ucrAvailableDataFrames.cboAvailableDataFrames.Text, strTempColumn:=ucrInputColumnIntoText.GetText)
    End Sub
