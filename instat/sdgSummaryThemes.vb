...
Public Class sdgSummaryThemes
    ...
    Private Sub InitialiseControls()
        ...
        ucrNudColumnsVlineWidth.SetParameter(New RParameter("column_labels.vlines.width", iNewPosition:=8))
        ...
        ucrInputColumnsVlineStyle.SetParameter(New RParameter("column_labels.vlines.style", iNewPosition:=9))
        ...
        ucrNudColumnsTopWidth.SetParameter(New RParameter("column_labels.border.top.width", iNewPosition:=8))
        ...
        ucrInputColumnsTopStyle.SetParameter(New RParameter("column_labels.border.top.style", iNewPosition:=9))
        ...
        ucrNudColumnsBottomWidth.SetParameter(New RParameter("column_labels.border.bottom.width", iNewPosition:=8))
        ...
        ucrInputColumnsBottomStyle.SetParameter(New RParameter("column_labels.border.bottom.style", iNewPosition:=9))
        ...
        ucrNudColumnsSideWidth.SetParameter(New RParameter("column_labels.border.lr.width", iNewPosition:=11))
        ...
        ucrInputColumnsSideStyle.SetParameter(New RParameter("column_labels.border.lr.style", iNewPosition:=12))
        ...
        ucrChkColumnsBackColor.AddToLinkedControls(ucrInputColumnsBackColor, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsTextTransform.AddToLinkedControls(ucrInputColumnsTextTransform, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsFontSize.AddToLinkedControls(ucrNudColumnsFontSize, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsFontWeight.AddToLinkedControls(ucrInputColumnsFontWeight, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsPadding.AddToLinkedControls(ucrInputColumnsPadding, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsHorizontalPadding.AddToLinkedControls(ucrInputColumnsHorizontalPadding, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsVlineWidth.AddToLinkedControls(ucrNudColumnsVlineWidth, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsVlineStyle.AddToLinkedControls(ucrInputColumnsVlineStyle, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsVlineColor.AddToLinkedControls(ucrInputColumnsVlineColor, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsBottomWidth.AddToLinkedControls(ucrNudColumnsBottomWidth, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsBottomStyle.AddToLinkedControls(ucrInputColumnsBottomStyle, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsBottomColor.AddToLinkedControls(ucrInputColumnsBottomColor, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsSideWidth.AddToLinkedControls(ucrNudColumnsSideWidth, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsSideStyle.AddToLinkedControls(ucrInputColumnsSideStyle, {True}, bNewLinkedHideIfParameterMissing:=True, bNewLinkedAddRemoveParameter:=True)
        ucrChkColumnsSideColor.AddToLinkedControls(ucrInputColumnsSideColor, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsTopWidth.AddToLinkedControls(ucrNudColumnsTopWidth, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkColumnsTopStyle.AddToLinkedControls(ucrInputColumnsTopStyle, {True}, bNewLinkedHideIfParameterMissing:=True, bNewLinkedAddRemoveParameter:=True)
        ucrChkColomnsTopColor.AddToLinkedControls(ucrInputColumnsTopColor, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
    ...
    Public Sub SetRCode(bReset As Boolean, clsNewThemesTabOption As RFunction)
        ...
        ucrInputColumnsPadding.SetRCode(clsThemesTabOptionsFunction, bReset, bCloneIfNeeded:=True)
        ucrInputColumnsHorizontalPadding.SetRCode(clsThemesTabOptionsFunction, bReset, bCloneIfNeeded:=True)
