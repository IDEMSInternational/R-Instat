...
Public Class dlgPlacketLuceModel
    ...
    Private clsCoefFunction, clsStatsFunction, clsLdplyFunction, clsPivotLongerFunction, clsPivotWiderFunction, clsListFunction, clsImportDataFunction, clsWrapTrees, clsSecondLibraryFunction As RFunction
