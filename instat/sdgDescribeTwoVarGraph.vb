...
Public Class sdgDescribeTwoVarGraph
    ...
    Public Sub InitialiseControls()
        ...
        ucrNumericByNumeric.SetItems({"Scatterplot", "Line plot", "Scatter and line plot"})
        ucrNumericByNumeric.SetName("Scatterplot")
        ucrNumericByNumeric.SetDropDownStyleAsNonEditable()
        ucrNumericByCategorical.SetItems({"Boxplot", "Histogram", "Density plot", "Frequency polygon", "Dot plot", "Point plot", "Violin plot", "Jitter plot", "Box plot + Jitter", "Violin Plot + Jitter plot", "Violin plot + Boxplot"})
        ...
        ucrCategoricalByNumeric.SetItems({"Boxplot", "Histogram", "Density plot", "Frequency polygon", "Dot plot", "Point plot", "Violin plot", "Jitter plot", "Box plot + Jitter", "Violin Plot + Jitter plot", "Violin plot + Boxplot"})
