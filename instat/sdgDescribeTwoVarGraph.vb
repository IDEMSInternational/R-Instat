...
Public Class sdgDescribeTwoVarGraph
    ...
    Public Sub InitialiseControls()
        ...
        ucrCategoricalByNumeric.SetItems({"Box plot", "Histogram", "Density plot", "Frequency polygon", "Dot plot", "Point plot", "Violin plot", "Jitter plot", "Box plot + Jitter", "Violin Plot + Jitter plot", "Violin plot + Box plot"})
