...
Public Class dlgAppend
    ...
    Private Sub InitialiseDialog()
        ...
        ' got:    Append <- bind_rows(x=InstatDataObject$get_data_frame(), .id="id")
        ' Want: ' Append <- bind_rows(.id="id", InstatDataObject$get_data_frame(data_name=c("Damango","Damango1")))
        ...
        'chkID
        SetParameter({ucrChkIncludeIDColumn, ucrInputIDColName}, New RParameter(".id", 2))
    ...
    '    Private Sub ucrInputNewDataframeName_NameChanged()
