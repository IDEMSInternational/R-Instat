...
Public Class dlgScript
    ...
    Private clsLibraryFunction, clsDummyTextFunction, clsLibraryExampleFunction, clsGetDataFrameFunction, clsSaveColumnFunction, clsConstantDummyFunction, clsGetColumnFunction,
    ...
    Private Sub SetDefaults()
        ...
        clsDummyTextFunction = New RFunction
        ...
        clsDummyTextFunction.AddParameter("preview", "", iPosition:=0)
    ...
    Private Sub ucrInputPreviewLibrary_ControlValueChanged(ucrChangedControl As ucrCore) Handles ucrInputPreviewLibrary.ControlContentsChanged
        TestOkEnabled()
        clsDummyTextFunction.AddParameter("preview", ucrInputPreviewLibrary.GetText, iPosition:=0)
    End Sub
    ...
    Private Sub SetPreviewScript(clsTempFunction As RFunction, strAssignTo As String)
        ...
        ucrInputPreviewLibrary.SetText(strAssignedTo)
    End Sub
    ...
    Private Sub SetRecentPreview()
        ucrInputPreviewLibrary.SetText(clsDummyTextFunction.GetParameter("preview").strArgumentValue)
    End Sub
