    ...
    Public Sub loadList()
        ...
        Select Case strDataType
            Case "column"
                ...
                End If
            Case "factor"
                If ucrReceiver IsNot Nothing AndAlso ucrReceiver.lstIncludedMetadataProperties.Count = 1 AndAlso ucrReceiver.strCurrDataType = "factor" AndAlso ucrReceiver.GetVariableNames <> "" Then
