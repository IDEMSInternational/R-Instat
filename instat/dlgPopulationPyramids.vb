...
Public Class dlgPopulationPyramids
    ...
    Private Sub InitialiseDialog()
        ...
        ucrBase.clsRsyntax.AddOperatorParameter("coord_flip", clsRFunc:=clsRgeom_bar2)
    ...
    Private Sub TestOkEnabled()
        If Not ucrXVariableReceiver.IsEmpty And Not ucrYVariableReceiver.IsEmpty Then
