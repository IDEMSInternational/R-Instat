...
Public Class ucrDataView
    ...
    Private Sub ResizeLabels()
        ...
        While lblRowDisplay.Width + lblColDisplay.Width + lblColDisplay.Width + lblColBack.Width + lblColFirst.Width + lblColLast.Width + lblColNext.Width + lblRowBack.Width + lblRowFirst.Width + lblRowNext.Width + lblRowLast.Width > TblPanPageDisplay.Width AndAlso TblPanPageDisplay.Font.Size > minSize
