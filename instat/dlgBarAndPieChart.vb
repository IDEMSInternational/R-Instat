...
Public Class dlgBarAndPieChart
    ...
    Private Sub SetDefaults()
        ...
        clsBaseOperator.AddParameter(strFirstParameterName, clsRFunctionParameter:=clsRgeomBarFunction, iPosition:=2)
