...
Public Class dlgBarAndPieChart
    ...
    Private Sub InitialiseDialog()
        ...
        ucrChkAddLabels.AddToLinkedControls(ucrInputLabelColour, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkAddLabels.AddToLinkedControls(ucrInputLabelPosition, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
        ucrChkAddLabels.AddToLinkedControls(ucrInputLabelSize, {True}, bNewLinkedAddRemoveParameter:=True, bNewLinkedHideIfParameterMissing:=True)
