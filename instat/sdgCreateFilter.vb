...
Public Class sdgCreateFilter
    ...
    Private Sub sdgCreateFilter_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        ...
        If Not ucrCreateFilter.ucrFilterByReceiver.IsEmpty Then
            result = Translations.MsgBoxTranslate("Are you sure you want to return to the main dialog?" & Environment.NewLine & "The condition for " & ucrCreateFilter.ucrFilterByReceiver.GetVariableNames(False) & " has not been added." & Environment.NewLine & "Click the " & Chr(34) & "Add Condition" & Chr(34) & " button if you want to add it.", MessageBoxButtons.YesNo, "Return to main dialog?", MessageBoxIcon.Information)
