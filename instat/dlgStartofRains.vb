...
Public Class dlgStartofRains
    ...
    Private Sub ucrReceiverStation_ControlValueChanged(ucrChangedControl As ucrCore) Handles ucrReceiverStation.ControlValueChanged, ucrReceiverDOY.ControlValueChanged
        DayBoundaries()
