...
Public Class dlgStartofRains
    ...
    Private Sub SetDefaults()
        ...
        clsListFunction.AddParameter("x", strStartStatus2, iPosition:=0)
        ...
        ucrBase.clsRsyntax.AddToAfterCodes(clsConvertColumnType2Function, iPosition:=6)
        SetReceiver()
        ChangeDSValue()
        AdditionalCondition()
    ...
    Private Sub GroupByStationOptions()
        If Not ucrReceiverStation.IsEmpty Then
            ...
            ucrBase.clsRsyntax.AddToAfterCodes(clsConvertssndLinkedVariableFunction, iPosition:=7)

        Else
            ucrBase.clsRsyntax.RemoveFromAfterCodes(clsDeleteunusedrowFunction)
            ucrBase.clsRsyntax.RemoveFromAfterCodes(clsConvertssndLinkedVariableFunction)
