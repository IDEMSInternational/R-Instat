...
Public Class dlgUseModel
    ...
    Private Sub cmdRHelpGeneral_Click(sender As Object, e As EventArgs) Handles cmdRHelpGeneral.Click, ToolStripStats.Click
    ...
    Private Sub ToolStripCar_Click(sender As Object, e As EventArgs) Handles ToolStripCar.Click
        If ucrInputComboRPackage.GetText = "General" Then
            strPackageName = "car"
        End If
        OpenHelpPage()
    ...
    Private Sub cmdRHelpPrediction_Click(sender As Object, e As EventArgs) Handles cmdRHelpPrediction.Click, ToolStripPrediction.Click
    ...
    Private Sub cmdRHelpSegmented_Click(sender As Object, e As EventArgs) Handles cmdRHelpSegmented.Click, ToolStripSegmented.Click
