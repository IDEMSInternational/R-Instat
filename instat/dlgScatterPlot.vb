...
Public Class dlgScatterPlot
    ...
    Private Sub SetDefaults()
        ...
        ' focus on mapping = aes within the ggplot function
        ' Default R
    ...
    Private Sub SetRCodeForControls(bReset As Boolean)
        ...
        '        ucrVariablesAsFactorForScatter.SetRCode(clsOverallFunction, bReset)
        '        ucrColors.SetRCode(clsOverallFunction, bReset)
