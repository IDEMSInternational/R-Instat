...
Public Class dlgEndOfRainsSeason
    ...
    Private Sub SetRCodeForControls(bReset As Boolean)
        ...
        'ucrPnlEvaporation.SetRCode(clsPMaxFunctionMax, bReset)
