...
Public Class dlgEndOfRainsSeason
    ...
    Private Sub ucrPnlEvaporation_ControlContentsChanged(ucrChangedControl As ucrCore) Handles ucrPnlEvaporation.ControlContentsChanged
        Evaporation()
        TestOKEnabled()
    End Sub
End Class