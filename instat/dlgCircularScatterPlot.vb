...
Public Class dlgCircularScatterPlot
    ...
    Private Sub SetDefaults()
        ...
        clsPlusOperator.SetAssignTo("last_graph", strTempDataframe:=ucrSelectorCircularDataFrame.ucrAvailableDataFrames.cboAvailableDataFrames.Text, strTempGraph:="last_graph")
    ...
    Public Sub SetRCodeForControls(bReset As Boolean)
        ...
        ucrSelectorCircularDataFrame.SetRCode(clsPipeOperator, bReset)
        ucrSaveScatterPlot.SetRCode(clsPlusOperator, bReset)
    End Sub

    Private Sub TestOkEnabled()
        ucrBase.OKEnabled(Not ucrReceiverVariable.IsEmpty AndAlso ucrSaveScatterPlot.IsComplete)
    End Sub
    ...
    Private Sub CoreControlsContentsChanged() Handles ucrReceiverVariable.ControlContentsChanged, ucrSaveScatterPlot.ControlContentsChanged
        TestOkEnabled()
    End Sub
End Class