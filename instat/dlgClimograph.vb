...
Public Class dlgClimograph
    ...
    Private Sub TestOKEnabled()
        If rdoWalterLieth.Checked Then
            If (Not ucrReceiverAbsolute.IsEmpty AndAlso Not ucrReceiverMaxtem.IsEmpty AndAlso Not ucrReceiverMintemp.IsEmpty AndAlso Not ucrReceiverMonth.IsEmpty AndAlso Not ucrReceiverRain.IsEmpty) OrElse Not ucrSave.IsComplete Then
