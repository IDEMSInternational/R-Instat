...
Public Class frmMain
    ...
    Private Sub mnuToolsClearOutputWindow_Click(sender As Object, e As EventArgs) Handles mnuToolsClearOutputWindow.Click
        ...
        rstResponse = MsgBoxTranslate("Are you sure you want to clear the Output Window?", MessageBoxButtons.YesNo, "Clear Output Window")
    ...
    Private Sub mnuFileCloseData_Click(sender As Object, e As EventArgs) Handles mnuFileCloseData.Click
        ...
        If Not bDataSaved _
                AndAlso DialogResult.No = MsgBoxTranslate("Are you sure you want to close your data?" &
