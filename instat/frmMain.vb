...
Public Class frmMain
    ...
    Private Sub mnuStructuredCircularRosePlot_Click(sender As Object, e As EventArgs) Handles mnuStructuredCircularRosePlot.Click
        dlgCircularRosePlot.ShowDialog()
    End Sub
End Class