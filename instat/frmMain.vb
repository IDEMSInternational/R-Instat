...
Public Class frmMain
    ...
    Private Sub SummaryToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles mnuDescribeSpecificSummaryFrequency.Click
        dlgSummaryFrequencyTables.ShowDialog()
    End Sub
