...
Partial Class dlgInventoryPlot
    ...
    Private Sub InitializeComponent()
        ...
        Me.ucrPnlSummaryAndGraph = New instat.UcrPanel()
        ...
        '
        'ucrPnlSummaryAndGraph
        '
        resources.ApplyResources(Me.ucrPnlSummaryAndGraph, "ucrPnlSummaryAndGraph")
        Me.ucrPnlSummaryAndGraph.Name = "ucrPnlSummaryAndGraph"
        '
        'rdoSummary
        '
        ...
        Me.Controls.Add(Me.ucrPnlSummaryAndGraph)
    ...
    Friend WithEvents ucrPnlSummaryAndGraph As UcrPanel
