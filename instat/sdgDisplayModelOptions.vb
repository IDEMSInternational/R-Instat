...
Public Class sdgDisplayModelOptions
    ...
    Private clsPlotFunction, clsHeatFunction, clsBarfunction As RFunction
    ...
    Private Sub InitialiseDialog()
        ...
        ucrChkBar.SetText("Heatmap of Estimated Worth")
        ucrChkHeat.SetText("Bar Chart of Estimated Worth")
