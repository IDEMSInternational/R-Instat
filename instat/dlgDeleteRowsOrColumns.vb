...
Public Class dlgDeleteRowsOrColumns
    ...
    Private Sub InitialiseDialog()
        ...
        ucrReceiverColumnsToIgnore.SetParameter(New RParameter("exclude_cols", 1))
        ucrReceiverColumnsToIgnore.Selector = ucrSelectorForDeleteColumns
        ucrReceiverColumnsToIgnore.SetParameterIsString()
        ucrReceiverColumnsToIgnore.SetLinkedDisplayControl(lblColumnsToIgnore)
    ...
    Private Sub SetRCodeForControls(bReset As Boolean)
        ...
        ucrReceiverColumnsToIgnore.SetRCode(clsRemoveEmptyColumns)
    ...
    Private Sub ReopenDialog()
        ...
        ucrReceiverColumnsToIgnore.Clear()
        SetMaxMin()
    End Sub
    ...
    Private Sub ucrPnlColumnsOrRows_ControlValueChanged(ucrChangedControl As ucrCore) Handles ucrPnlColumnsOrRows.ControlValueChanged
        If rdoColumns.Checked Then
            ...
            lblColumnsToIgnore.Visible = False
            ucrReceiverColumnsToIgnore.Visible = False
            ucrReceiverForColumnsToDelete.SetMeAsReceiver()
        ElseIf rdoRows.Checked Then
