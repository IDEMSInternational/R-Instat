...
Public Class dlgHypothesisTestsCalculator
    ...
    Private Sub cmdBinom_Click(sender As Object, e As EventArgs) Handles cmdBinom.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("binom.test(x= , n= , p = 0.5, alternative = c(""two.sided"", ""less"", ""greater""),conf.level = 0.95)")
        Else
    ...
    Private Sub cmdBox_Click(sender As Object, e As EventArgs) Handles cmdBox.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("Box.test(x= , lag = 1, type = c(""Box-Pierce"", ""Ljung-Box""), fitdf = 0)")
        Else
    ...
    Private Sub cmdChisq_Click(sender As Object, e As EventArgs) Handles cmdChisq.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("chisq.test(x= , y = NULL, correct = TRUE,p = rep(1/length(x), length(x)), rescale.p = FALSE,simulate.p.value = FALSE, B = 2000)", 5)
        Else
    ...
    Private Sub cmdCor_Click(sender As Object, e As EventArgs) Handles cmdCor.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("cor.test(x= , y= ,alternative = c(""two.sided"", ""less"", ""greater""),method = c(""pearson"", ""kendall"", ""spearman""),exact = NULL, conf.level = 0.95, continuity = FALSE, ...)", 5)
        Else
    ...
    Private Sub cmdfisher_Click(sender As Object, e As EventArgs) Handles cmdfisher.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("fisher.test(x= , y = NULL, workspace = 200000, hybrid = FALSE,control = list(), or = 1, alternative = ""two.sided"",conf.int = TRUE, conf.level = 0.95,simulate.p.value = FALSE, B = 2000)", 5)
        Else
    ...
    Private Sub cmdfligner_Click(sender As Object, e As EventArgs) Handles cmdfligner.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("fligner.test(x= , g= )", 5)
        Else
    ...
    Private Sub cmdFriedman_Click(sender As Object, e As EventArgs) Handles cmdFriedman.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("friedman.test(y=  ", 5)
        Else
    ...
    Private Sub cmdKs_Click(sender As Object, e As EventArgs) Handles cmdKs.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("ks.test(x= , y= ,alternative = c(""two.sided"", ""less"", ""greater""),exact = NULL)", 5)
        Else
    ...
    Private Sub cmdKruskal_Click(sender As Object, e As EventArgs) Handles cmdKruskal.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("kruskal.test(x= , g= )", 5)
        Else
    ...
    Private Sub cmdMauchly_Click(sender As Object, e As EventArgs) Handles cmdMauchly.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("mauchly.test(object= )", 5)
        Else
    ...
    Private Sub cmdWilcox_Click(sender As Object, e As EventArgs) Handles cmdWilcox.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("wilcox.test(x= , y = NULL,alternative = c(""two.sided"", ""less"", ""greater""),mu = 0, paired = FALSE, exact = NULL, correct = TRUE,conf.int = FALSE, conf.level = 0.95)", 5)
        Else
    ...
    Private Sub cmdMcnemar_Click(sender As Object, e As EventArgs) Handles cmdMcnemar.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("mcnemar.test(x= , y = NULL, correct = TRUE)", 5)
        Else
    ...
    Private Sub cmdMood_Click(sender As Object, e As EventArgs) Handles cmdMood.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("mood.test(x= , y= ,alternative = c(""two.sided"", ""less"", ""greater""))", 5)
        Else
    ...
    Private Sub cmdOneway_Click(sender As Object, e As EventArgs) Handles cmdOneway.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("oneway.test(formula= , data = , subset= , na.action= , var.equal = FALSE)", 5)
        Else
    ...
    Private Sub cmdPairwiseProp_Click(sender As Object, e As EventArgs) Handles cmdPairwiseProp.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("pairwise.prop.test(x= , n= , p.adjust.method = p.adjust.method)", 5)
        Else
    ...
    Private Sub cmdPairwiset_Click(sender As Object, e As EventArgs) Handles cmdPairwiset.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("pairwise.t.test(x= , g= , p.adjust.method = p.adjust.methods,pool.sd = !paired, paired = FALSE,alternative = c(""two.sided"", ""less"", ""greater""),)", 5)
        Else
    ...
    Private Sub cmdPaiwiseWilcox_Click(sender As Object, e As EventArgs) Handles cmdPaiwiseWilcox.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("pairwise.wilcox.test(x= , g= , p.adjust.method = p.adjust.methods,paired = FALSE)", 5)
        Else
    ...
    Private Sub cmdPowerAnova_Click(sender As Object, e As EventArgs) Handles cmdPowerAnova.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("power.anova.test(groups = NULL, n = NULL,between.var = NULL, within.var = NULL,sig.level = 0.05, power = NULL)", 5)
        Else
    ...
    Private Sub cmdPowerProp_Click(sender As Object, e As EventArgs) Handles cmdPowerProp.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("power.prop.test(n = NULL, p1 = NULL, p2 = NULL, sig.level = 0.05, power = NULL,alternative = c(""two.sided"", ""one.sided""),strict = FALSE, tol = .Machine$double.eps^0.25)", 5)
        Else
    ...
    Private Sub cmdPowerT_Click(sender As Object, e As EventArgs) Handles cmdPowerT.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("power.t.test(n = NULL, delta = NULL, sd = 1, sig.level = 0.05,power = NULL,type = c(""two.sample"", ""one.sample"", ""paired""),alternative = c(""two.sided"", ""one.sided""), strict = FALSE, tol = .Machine$double.eps^0.25)", 5)
        Else
    ...
    Private Sub cmdPropTrend_Click(sender As Object, e As EventArgs) Handles cmdPropTrend.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("prop.trend.test(x= , n= , score = seq_along(x))", 5)
        Else
    ...
    Private Sub cmdVar_Click(sender As Object, e As EventArgs) Handles cmdVar.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("var.test(x= , y= , ratio = 1,alternative = c(""two.sided"", ""less"", ""greater""),conf.level = 0.95)", 5)
        Else
    ...
    Private Sub btnPoisson_Click(sender As Object, e As EventArgs) Handles btnPoisson.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("poisson.test(x= , T = 1, r = 1, alternative = c(""two.sided"", ""less"", ""greater""),conf.level = 0.95)", 5)
        Else
    ...
    Private Sub btnProp_Click(sender As Object, e As EventArgs) Handles btnProp.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("prop.test(x= , n= , p = NULL,alternative = c(""two.sided"", ""less"", ""greater""),conf.level = 0.95, correct = TRUE)", 5)
        Else
    ...
    Private Sub btnT_Click(sender As Object, e As EventArgs) Handles btnT.Click
        If ucrChkShowArguments.Checked Then
            ucrReceiverForTestColumn.AddToReceiverAtCursorPosition("t.test(x= , y = NULL,alternative = c(""two.sided"", ""less"", ""greater""),mu = 0, paired = FALSE, var.equal = FALSE,conf.level = 0.95)", 5)
        Else
