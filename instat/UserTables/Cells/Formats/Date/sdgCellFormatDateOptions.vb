Public Class sdgCellFormatDateOptions
    ...
    Private Sub InitialiseDialog()
        Dim dctDateFormat As New Dictionary(Of String, String) From {
            ...
            {"month", Chr(34) & "February" & Chr(34)},
            {"day", Chr(34) & "29" & Chr(34)},
            {"year.mn.day", Chr(34) & "2000/02/29" & Chr(34)},
            {"y.mn.day", Chr(34) & "00/02/29" & Chr(34)},
            {"year_week", Chr(34) & "2000-W09" & Chr(34)},
            {"year_quarter", Chr(34) & "2000-Q1" & Chr(34)},
            {"yMd", Chr(34) & "2/29/2000" & Chr(34)},
            {"yMEd", Chr(34) & "Tue, 2/29/2000" & Chr(34)},
            {"yMMM", Chr(34) & "Feb 2000" & Chr(34)},
            {"yMMMM", Chr(34) & "February 2000" & Chr(34)},
            {"yMMMd", Chr(34) & "Feb 29, 2000" & Chr(34)},
            {"yMMMEd", Chr(34) & "Tue, Feb 29, 2000" & Chr(34)},
            {"GyMd", Chr(34) & "2/29/2000 A" & Chr(34)},
            {"GyMMMd", Chr(34) & "Feb 29, 2000 AD" & Chr(34)},
            {"GyMMMEd", Chr(34) & "Tue, Feb 29, 2000 AD" & Chr(34)},
            {"yM", Chr(34) & "2/2000" & Chr(34)},
            {"Md", Chr(34) & "2/29" & Chr(34)},
            {"MEd", Chr(34) & "Tue, 2/29" & Chr(34)},
            {"MMMd", Chr(34) & "Feb 29" & Chr(34)},
            {"MMMEd", Chr(34) & "Tue, Feb 29" & Chr(34)},
            {"MMMMd", Chr(34) & "February 29" & Chr(34)},
            {"GyMMM", Chr(34) & "Feb 2000 AD" & Chr(34)},
            {"yQQQ", Chr(34) & "Q1 2000" & Chr(34)},
            {"yQQQQ", Chr(34) & "1st quarter 2000" & Chr(34)},
            {"Gy", Chr(34) & "2000 AD" & Chr(34)},
            {"y", Chr(34) & "2000" & Chr(34)},
            {"MMM", Chr(34) & "Feb" & Chr(34)},
            {"d", Chr(34) & "29" & Chr(34)},
            {"Ed", Chr(34) & "29 Tue" & Chr(34)}
        }
