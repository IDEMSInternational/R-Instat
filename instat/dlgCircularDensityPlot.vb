...
        If ucrVariablesAsFactorforDensity.IsEmpty OrElse Not ucrSaveDensity.IsComplete Then
    ...
    Private Sub cmdDensityOptions_Click(sender As Object, e As EventArgs) Handles cmdDensityOptions.Click
        sdgLayerOptions.SetupLayer(clsNewGgPlot:=clsRggplotFunction, clsNewGeomFunc:=clsRgeomPlotFunction, clsNewGlobalAesFunc:=clsRaesFunction, clsNewLocalAes:=clsLocalRaesFunction, bFixGeom:=True, ucrNewBaseSelector:=ucrDensitySelector, bApplyAesGlobally:=True, bReset:=bResetHistLayerSubdialog)
