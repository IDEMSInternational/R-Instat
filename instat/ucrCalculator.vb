...
Public Class ucrCalculator
    ...
    Public Sub InitialiseControls()
        ...
        ttCalculator.SetToolTip(cmdOctal, "converts an integer into octal number. For example, intToOct(c(2,5,12,17))= 02,05,14,21")
        ttCalculator.SetToolTip(cmdHex, "converts an integer into hexadecimal number. For example, intToHex(c(2,7,10,15)))= 2,7,a,f")
        ttCalculator.SetToolTip(cmdOctmode, "converts an integer into a octal number. For example, as.octmode(intToOct(c(2,5,12,17)))= 02,05,14,21")
        ...
        ttCalculator.SetToolTip(cmdRoman, "converts a small(upto 3899) positive integer to Roman numbers. For example as.roman(14)=XIV")
        ttCalculator.SetToolTip(cmdPalindrome, "Generate palindromes to the length of the dataframe. For example the 100th palindromic number is 909")
