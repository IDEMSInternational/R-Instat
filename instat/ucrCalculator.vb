...
Public Class ucrCalculator
    ...
    Public Sub InitialiseControls()
        ucrInputCalOptions.SetItems({"Basic", "Logical and Symbols", "Summary", "Strings (Character Columns)", "Probability", "Dates", "Transform", "Wakefield"}) ' "Rows" is a temp. name
    ...
    Private Sub CalculationsOptions()
        Select Case ucrInputCalOptions.GetText
            Case "Maths"
                ...
                iHelpCalcID = 126
                Me.Size = New Size(iBasicWidth * 1.38, iBasicHeight)
            Case "Logical and Symbols"
                ...
                grpWakefield.Visible = False
                iHelpCalcID = 127
                Me.Size = New Size(iBasicWidth * 1.44, iBasicHeight)
                grpProbabilty.Visible = False
                grpTransform.Visible = False
            Case "Summary"
                grpDates.Visible = False
                ...
                grpWakefield.Visible = False
                iHelpCalcID = 128
                Me.Size = New Size(iBasicWidth * 1.51, iBasicHeight)
                grpStrings.Visible = False
                grpProbabilty.Visible = False
                grpTransform.Visible = False
            Case "Strings (Character Columns)"
                ...
                grpWakefield.Visible = False
                iHelpCalcID = 129
                Me.Size = New Size(iBasicWidth * 1.42, iBasicHeight)
            Case "Probability"
                grpDates.Visible = False
                ...
                grpWakefield.Visible = False
                iHelpCalcID = 120
                Me.Size = New Size(iBasicWidth * 1.57, iBasicHeight)
            Case "Dates"
                ...
                grpWakefield.Visible = False
                iHelpCalcID = 130
                Me.Size = New Size(iBasicWidth * 1.32, iBasicHeight)
            Case "Transform"
                grpDates.Visible = False
                grpProbabilty.Visible = False
                grpSummary.Visible = False
                ...
                grpWakefield.Visible = False
                Me.Size = New Size(iBasicWidth * 1.33, iBasicHeight)
            Case "Wakefield"
                grpDates.Visible = False
                grpProbabilty.Visible = False
                grpSummary.Visible = False
                ...
                Me.Size = New Size(iBasicWidth * 1.7, iBasicHeight * 1.07)
            Case Else
                grpDates.Visible = False
    ...
    Private Sub cmdPrimary_Click(sender As Object, e As EventArgs) Handles cmdPrimary.Click
        If chkShowArguments.Checked Then
            ucrReceiverForCalculation.AddToReceiverAtCursorPosition("wakefield::primary(n = ,  x = c(""Red"" , ""Green"" , ""Blue"" , ""Yellow"" , ""Black"" , ""White"") , prob = NULL, name = ""Color"")", 104)
        Else
    ...
    Private Sub cmdReligion_Click(sender As Object, e As EventArgs) Handles cmdReligion.Click
        If chkShowArguments.Checked Then
            ucrReceiverForCalculation.AddToReceiverAtCursorPosition("wakefield::religion(n = , x = c(""Christian"" , ""Muslim"" , ""None"" , ""Hindu"" , ""Buddhist"" , ""Folk"" , ""Other"", ""Jewish""), prob = c(0.31477, 0.23163, 0.16323, 0.14985, 0.07083,0.05882, 0.00859, 0.00227), name = ""Religion"")", 1)
        Else
