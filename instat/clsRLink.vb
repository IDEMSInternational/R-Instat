...
Public Class RLink
    ...
    '''--------------------------------------------------------------------------------------------
    Public Sub RunScript(strScript As String, Optional iCallType As Integer = 0, Optional returnType As R_ReturnType = R_ReturnType.IgnoreResult, Optional strComment As String = "", Optional bSeparateThread As Boolean = True, Optional bShowWaitDialogOverride As Nullable(Of Boolean) = Nothing, Optional bUpdateGrids As Boolean = True, Optional bSilent As Boolean = False, Optional scriptType As ScriptType = ScriptType.Script)
        'ToDo bSilent = do not show error messages. This should be done via the type of script and output
        ...
        Select Case returnType
            Case R_ReturnType.IgnoreResult
                RunScriptAndIgnoreResult(strScript, bSeparateThread, bShowWaitDialogOverride, bSilent)
            Case R_ReturnType.ResultAsTemporaryVariable
                strOutput = RunScriptAndStoreInTemporaryVariable(strScript, bSeparateThread, bShowWaitDialogOverride, bSilent)
            Case R_ReturnType.ResultAsText
                strOutput = RunScriptAndShowAsText(strScript, bSeparateThread, bShowWaitDialogOverride, bSilent)
            Case R_ReturnType.ResultAsImage
                strOutput = RunScriptAndShowAsImage(strScript, bSeparateThread, bShowWaitDialogOverride, bSilent)
            Case R_ReturnType.ResultAsWebControl
                strOutput = RunScriptAndShowInWeb(strScript, bSeparateThread, bShowWaitDialogOverride, bSilent)
            Case Else
        ...
        'ToDo Log should be included with the outputLogger
        If bLog Then
        ...
        'If bOutput Then
        '    clsOutputLogger.AddRScript(strScriptWithComment, scriptType)
        'End If
    ...
    Private Sub RunScriptAndIgnoreResult(strScript As String, bSeparateThread As Boolean, bShowWaitDialogOverride As Boolean?, bSilent As Boolean)
        'ToDo bSilent = do not show error messages. This should be done via the type of script and output
    ...
    Private Function RunScriptAndStoreInTemporaryVariable(strScript As String, bSeparateThread As Boolean, bShowWaitDialogOverride As Boolean?, bSilent As Boolean) As String
        'ToDo bSilent = do not show error messages. This should be done via the type of script and output 
    ...
    'Private Function WrapScriptWithCaptureOutput(strScript As String)
    '    Dim strSplitScript As String
    '    Dim strCapturedScript As String
    ...
    Private Function RunScriptAndShowAsText(strScript As String, bSeparateThread As Boolean, bShowWaitDialogOverride As Boolean?, bSilent As Boolean)
        'ToDo bSilent = do not show error messages. This should be done via the type of script and output
    ...
    Private Function RunScriptAndShowAsImage(strScript As String, bSeparateThread As Boolean, bShowWaitDialogOverride As Boolean?, bSilent As Boolean) As String
        'ToDo bSilent = do not show error messages. This should be done via the type of script and output
    ...
    Private Function RunScriptAndShowInWeb(strScript As String, bSeparateThread As Boolean, bShowWaitDialogOverride As Boolean?, bSilent As Boolean) As String
        Dim strCapturedScript As String
        Dim expTemp As RDotNet.SymbolicExpression
        Dim strOutput As String = ""
        Dim strSplitScript As String
