...
Public Class DlgDefineClimaticData
    ...
    Private Sub InitialiseDialog()
        ...
        ucrReceiverCloudCover.strSelectorHeading = "Cloud Cover Variables"
        ucrReceiverStationName.Tag = "station"
        ucrReceiverStationName.strSelectorHeading = "Station Variables"
        ucrReceiverMaxTemp.Tag = "temp_max"
        ucrReceiverMaxTemp.strSelectorHeading = "Max Temperature"
        ucrReceiverMinTemp.Tag = "temp_min"
        ucrReceiverMinTemp.strSelectorHeading = "Min Temperature"
        ucrReceiverRadiation.Tag = "radiation"
        ucrReceiverRadiation.strSelectorHeading = "Radiation Variables"
        ...
        ucrReceiverDOY.strSelectorHeading = "DOY Variables"
