...
Public Class ucrGeom
    ...
    Public Sub CreateGeomList()
        ...
        clsgeom_label_repel.AddLayerParameter("size", "numeric", "1", lstParameterStrings:={1, 1})
        ...
        clsgeom_text_repel.AddLayerParameter("size", "numeric", "1", lstParameterStrings:={1, 0})
