...
Public Class ucrGeom
    ...
    Public Sub CreateGeomList()
        ...
        clsgeom_statsummary.AddLayerParameter("fun.y", "editablelist", Chr(34) & "mean" & Chr(34), lstParameterStrings:={Chr(34) & "median" & Chr(34), Chr(34) & "mean" & Chr(34), Chr(34) & "lower quartile" & Chr(34), Chr(34) & "upper quartile" & Chr(34)})
