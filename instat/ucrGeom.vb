...
Public Class ucrGeom
    ...
    Public Sub CreateGeomList()
        ...
        clsgeom_mosaic.AddAesParameter("weight")

        'adding layerParameters
        clsgeom_mosaic.AddLayerParameter("divider", "list", Chr(34) & "vspine" & Chr(34), lstParameterStrings:={Chr(34) & "vspine" & Chr(34), Chr(34) & "hspine" & Chr(34), Chr(34) & "vbar" & Chr(34), Chr(34) & "hbar" & Chr(34)})
