...
Public Class ucrGeom
    ...
    Public Sub CreateGeomList()
        ...
        clsgeom_statcor.AddLayerParameter("label.x", "numeric", "0", lstParameterStrings:={0, -1000, 1000})
        clsgeom_statcor.AddLayerParameter("label.y", "numeric", "0", lstParameterStrings:={0, -1000, 1000})
        ...
        clsgeom_statReglineEquation.AddLayerParameter("label.x", "numeric", "0", lstParameterStrings:={0, -1000, 1000})
        clsgeom_statReglineEquation.AddLayerParameter("label.y", "numeric", "0", lstParameterStrings:={0, -1000, 1000})
