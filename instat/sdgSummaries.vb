...
Public Class sdgSummaries
    ...
    Public Sub InitialiseControls()
        ...
        lstCheckboxes.AddRange({ucrChkNTotal, ucrChkNonMissing, ucrChkNMissing, ucrChkMean, ucrChkMinimum, ucrChkMode, ucrChkMaximum, ucrChkMedian, ucrChkStdDev, ucrChkVariance, ucrChkRange, ucrChkSum, ucrChkQuartiles, ucrChkUpperQuartile, ucrChkLowerQuartile})
