...
Public Class sdgSummaries
    ...
    Public Sub InitialiseControls()
        ...
        ucrChkP10.SetParameter(New RParameter("p10", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p10" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP20.SetParameter(New RParameter("p20", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p20" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP25.SetParameter(New RParameter("p25", 14), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p25" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP30.SetParameter(New RParameter("p30", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p30" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP33.SetParameter(New RParameter("p33", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p33" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP40.SetParameter(New RParameter("p40", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p40" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP60.SetParameter(New RParameter("p60", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p60" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP67.SetParameter(New RParameter("p67", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p67" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP70.SetParameter(New RParameter("p70", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p70" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP75.SetParameter(New RParameter("p75", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p75" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP80.SetParameter(New RParameter("p80", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p80" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
        ucrChkP90.SetParameter(New RParameter("p90", 13), bNewChangeParameterValue:=True, bNewAddRemoveParameter:=True, strNewValueIfChecked:=Chr(34) & "p90" & Chr(34), strNewValueIfUnchecked:=Chr(34) & Chr(34))
