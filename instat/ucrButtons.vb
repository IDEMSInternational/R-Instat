...
Public Class ucrButtons
    ...
    Public strHelpFilePath As String = frmMain.strHelpFilePath
    ...
    Private Sub cmdHelp_Click(sender As Object, e As EventArgs) Handles cmdHelp.Click
        ...
        If (System.IO.File.Exists(strHelpFilePath)) Then
            ' (1) Use HelpNDoc's Help Context number. Not dependent on HelpNDoc.
            Help.ShowHelp(Me, strHelpFilePath, HelpNavigator.TopicId, "126")
