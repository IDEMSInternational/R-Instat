...
Public Class dlgThreeVariableModelling
    ...
    Public Sub ResponseConvert()
        If Not ucrResponse.IsEmpty Then
            ucrFamily.ReceiverDatatype(ucrSelectorThreeVariableModelling.ucrAvailableDataFrames.cboAvailableDataFrames.Text, ucrResponse.GetVariableNames(bWithQuotes:=False))
