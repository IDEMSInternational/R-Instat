...
Public Class sdgClimaticNCMPMetadata
    ...
    Private Sub sdgClimaticNCMPMetadata_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        ...
        If bWarning Then
            result = MsgBoxTranslate(text:="Information missing. See details below. OK will not be enabled on the main dialog until resolved." & Environment.NewLine & "Are you sure you want to return to the main dialog?" & Environment.NewLine & strMessage, buttons:=MessageBoxButtons.YesNo, title:="Missing information", Icon:=MessageBoxIcon.Information)
