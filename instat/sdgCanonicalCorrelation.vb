...
'    Private Sub ucrChkCanonicalCorrelations_ControlValueChanged(ucrChangedControl As ucrCore)
...
'    Private Sub ucrChkPairwisePlot_ControlValueChanged(ucrChangedControl As ucrCore)
