...
Public Class dlgBoxplot
    ...
    Public Sub SetRCodeForControls(bReset As Boolean)
        ...
        ucrByFactorsReceiver.AddAdditionalCodeParameterPair(clsSecondGroupByFunction, New RParameter("x", 0, bNewIncludeArgumentName:=False), iAdditionalPairNo:=1)
        ucrSecondFactorReceiver.AddAdditionalCodeParameterPair(clsSecondGroupByFunction, New RParameter("y", 1, bNewIncludeArgumentName:=False), iAdditionalPairNo:=1)
    ...
    Private Sub TestOkEnabled()
        ...
        If ucrVariablesAsFactorForBoxplot.IsEmpty OrElse (ucrSaveBoxplot.ucrChkSave.Checked AndAlso Not ucrSaveBoxplot.IsComplete) Then
            bEnableOk = False
    ...
    Private Sub ucrVariablesAsFactorForBoxplot_ControlValueChanged(ucrChangedControl As ucrCore) Handles ucrVariablesAsFactorForBoxplot.ControlValueChanged
        TestOkEnabled()
    End Sub
    ...
    Private Sub ucrSaveBoxplot_ControlContentsChanged(ucrChangedControl As ucrCore) Handles ucrSaveBoxplot.ControlContentsChanged, ucrNudOutlierCoefficient.ControlContentsChanged, ucrVariablesAsFactorForBoxplot.ControlContentsChanged
        TestOkEnabled()
    End Sub
